{{ config(materialized='view', schema='TIMELINE', alias='HEALTH__FED_CDC_SUICIDE_RATES') }}
...
--
-- Canonical clock for HEALTH.HEALTH__FED_CDC_SUICIDE_RATES.
--   column : YEAR   (NUMBER)
--   means  : happened -- try_to_number(YEAR) - year the rate describes; nulls on any range-valued rows.
--   grain  : year
--
...
select
    ...
    'HEALTH.HEALTH__FED_CDC_SUICIDE_RATES'::varchar as ripple_source,
    src.*
from {{ ref('health__fed_cdc_suicide_rates') }} as src
