{{ config(materialized='view', schema='TIMELINE', alias='FINANCE__FED_SEC_DERA_SUB_2026Q1') }}
...
--
-- Canonical clock for FINANCE.FINANCE__FED_SEC_DERA_SUB_2026Q1.
--   column : FILED   (TEXT)
...
select
    ...
    'FINANCE.FINANCE__FED_SEC_DERA_SUB_2026Q1'::varchar as ripple_source,
    src.*
from {{ ref('finance__fed_sec_dera_sub_2026q1') }} as src
