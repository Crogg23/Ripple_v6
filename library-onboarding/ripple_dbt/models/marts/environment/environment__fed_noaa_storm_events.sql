...
select
    ...
    CZ_NAME as cz_name,
    WFO as wfo,
    try_to_timestamp(nullif(trim(BEGIN_DATE_TIME), ''), 'DD-MON-YY HH24:MI:SS') as begin_date_time,
    CZ_TIMEZONE as cz_timezone,
    try_to_timestamp(nullif(trim(END_DATE_TIME), ''), 'DD-MON-YY HH24:MI:SS') as end_date_time,
    ...
    {{ ripple_num('TOR_LENGTH') }} as tor_length,
    {{ ripple_num('TOR_WIDTH') }} as tor_width,
