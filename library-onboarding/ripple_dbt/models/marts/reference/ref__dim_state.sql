...
-- GRAIN: one row per US state/territory (56 rows: 50 states + DC + 5 territories)
-- Answers: Standard state reference for joins across all geographic data
-- Source: Hardcoded reference data
-- Key joins: state_abbr or state_fips used across most source tables

select column1 as state_fips, column2 as state_abbr, column3 as state_name, column4 as census_region, column5 as census_division
from values
    ...
    ('60', 'AS', 'American Samoa', 'Territory', 'Pacific'),
    ('66', 'GU', 'Guam', 'Territory', 'Pacific'),
    ('69', 'MP', 'Northern Mariana Islands', 'Territory', 'Pacific'),
    ('72', 'PR', 'Puerto Rico', 'Territory', 'Caribbean'),
    ('78', 'VI', 'Virgin Islands', 'Territory', 'Caribbean')
