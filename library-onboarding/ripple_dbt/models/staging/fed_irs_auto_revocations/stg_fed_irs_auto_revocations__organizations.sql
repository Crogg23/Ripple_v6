...
select * from renamed
qualify row_number() over (partition by ein, legal_name, doing_business_as, organization_address, city, state, zip_code, country, exemption_type, revocation_date, revocation_posting_date, reinstatement_date order by _loaded_at desc) = 1
