...
renamed as (
    ...
    select
        ...
        {{ stg_float('trim(NET_SUMMER_CAPACITY_WITH_NATURAL_GAS_MW)') }} as net_summer_capacity_with_natural_gas_mw,
        {{ stg_float('trim(NET_WINTER_CAPACITY_WITH_NATURAL_GAS_MW)') }} as net_winter_capacity_with_natural_gas_mw,
        {{ stg_float('trim(NET_SUMMER_CAPACITY_WITH_OIL_MW)') }}         as net_summer_capacity_with_oil_mw,
        {{ stg_float('trim(NET_WINTER_CAPACITY_WITH_OIL_MW)') }}         as net_winter_capacity_with_oil_mw,
