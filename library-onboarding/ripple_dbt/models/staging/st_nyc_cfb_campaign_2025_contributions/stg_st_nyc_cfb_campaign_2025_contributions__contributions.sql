...
-- (RECIPID, COMMITTEE, FILING, REFNO) is EXACTLY unique (259,537 rows =
-- 259,537 distinct, verified live by the orchestrator). contribution_record_id
...
with source as (
    ...
    select * from {{ source('ripple_raw', 'ST_NYC_CFB_CAMPAIGN_2025_CONTRIBUTIONS') }}
