...
-- (RECIPID, COMMITTEE, FILING, REFNO) is EXACTLY unique (146,112 rows =
-- 146,112 distinct, verified live by the orchestrator). contribution_record_id
...
with source as (
    ...
    select * from {{ source('ripple_raw', 'ST_NYC_CFB_CAMPAIGN_2009_CONTRIBUTION') }}
