...
renamed as (
    ...
    select
        ...
        {{ stg_int('trim(FAC_LATITUDE)') }}              as fac_latitude,
        {{ stg_int('trim(FAC_LONGITUDE)') }}             as fac_longitude,
        {{ stg_float('trim(PREF_LATITUDE)') }}             as pref_latitude,
        {{ stg_float('trim(PREF_LONGITUDE)') }}            as pref_longitude,
