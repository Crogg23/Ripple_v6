...
-- (RECIPID, COMMITTEE, FILING, REFNO) is EXACTLY unique (457,521 rows =
-- 457,521 distinct, verified live by the orchestrator). contribution_record_id
...
with source as (
    ...
    select * from {{ source('ripple_raw', 'ST_NYC_CFB_CAMPAIGN_2021_CONTRIBUTIONS') }}
