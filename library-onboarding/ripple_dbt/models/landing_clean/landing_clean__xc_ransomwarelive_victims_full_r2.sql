{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_RANSOMWARELIVE_VICTIMS_FULL_R2') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_RANSOMWARELIVE_VICTIMS_FULL_R2, from the
...
from {{ source('ripple_raw', 'XC_RANSOMWARELIVE_VICTIMS_FULL_R2') }} as source
