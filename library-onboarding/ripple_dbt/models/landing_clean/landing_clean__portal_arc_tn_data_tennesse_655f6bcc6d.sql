{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_TN_DATA_TENNESSE_655F6BCC6D') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_TN_DATA_TENNESSE_655F6BCC6D, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_TN_DATA_TENNESSE_655F6BCC6D') }} as source
