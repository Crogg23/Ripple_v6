{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CDC_WONDER') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CDC_WONDER, from the
...
from {{ source('ripple_raw', 'FED_CDC_WONDER') }} as source
