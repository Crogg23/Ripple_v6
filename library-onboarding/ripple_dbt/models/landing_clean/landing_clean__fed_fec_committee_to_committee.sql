{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FEC_COMMITTEE_TO_COMMITTEE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FEC_COMMITTEE_TO_COMMITTEE, from the
...
from {{ source('ripple_raw', 'FED_FEC_COMMITTEE_TO_COMMITTEE') }} as source
