{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_CHICAGO_DATA_POR_FC19B9A2BE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_CHICAGO_DATA_POR_FC19B9A2BE, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_CHICAGO_DATA_POR_FC19B9A2BE') }} as source
