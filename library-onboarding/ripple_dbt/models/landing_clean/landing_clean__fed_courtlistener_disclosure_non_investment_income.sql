{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_COURTLISTENER_DISCLOSURE_NON_INVESTMENT_INCOME') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_COURTLISTENER_DISCLOSURE_NON_INVESTMENT_INCOME, from the
...
from {{ source('ripple_raw', 'FED_COURTLISTENER_DISCLOSURE_NON_INVESTMENT_INCOME') }} as source
