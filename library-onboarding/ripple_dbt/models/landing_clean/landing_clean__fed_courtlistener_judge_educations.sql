{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_COURTLISTENER_JUDGE_EDUCATIONS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_COURTLISTENER_JUDGE_EDUCATIONS, from the
...
from {{ source('ripple_raw', 'FED_COURTLISTENER_JUDGE_EDUCATIONS') }} as source
