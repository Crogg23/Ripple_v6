{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_0CCFFFCC26') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_0CCFFFCC26, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_0CCFFFCC26') }} as source
