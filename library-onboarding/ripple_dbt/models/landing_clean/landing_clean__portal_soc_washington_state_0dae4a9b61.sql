{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_WASHINGTON_STATE_0DAE4A9B61') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_WASHINGTON_STATE_0DAE4A9B61, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_WASHINGTON_STATE_0DAE4A9B61') }} as source
