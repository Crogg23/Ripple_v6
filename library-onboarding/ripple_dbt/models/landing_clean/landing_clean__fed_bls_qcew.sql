{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_BLS_QCEW') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_BLS_QCEW, from the
...
from {{ source('ripple_raw', 'FED_BLS_QCEW') }} as source
