{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_FRS_FRS_NAICS_CODES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_FRS_FRS_NAICS_CODES, from the
...
from {{ source('ripple_raw', 'FED_EPA_FRS_FRS_NAICS_CODES') }} as source
