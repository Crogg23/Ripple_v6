{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_RURAL_HEALTH_CLINIC_ENROLLMENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_RURAL_HEALTH_CLINIC_ENROLLMENTS, from the
...
from {{ source('ripple_raw', 'FED_CMS_RURAL_HEALTH_CLINIC_ENROLLMENTS') }} as source
