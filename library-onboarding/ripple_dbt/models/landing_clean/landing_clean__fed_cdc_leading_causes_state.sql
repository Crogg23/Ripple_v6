{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CDC_LEADING_CAUSES_STATE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CDC_LEADING_CAUSES_STATE, from the
...
from {{ source('ripple_raw', 'FED_CDC_LEADING_CAUSES_STATE') }} as source
