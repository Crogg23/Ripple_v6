{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_TAMPA_OPEN_DATA_662D0D6BCB') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_TAMPA_OPEN_DATA_662D0D6BCB, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_TAMPA_OPEN_DATA_662D0D6BCB') }} as source
