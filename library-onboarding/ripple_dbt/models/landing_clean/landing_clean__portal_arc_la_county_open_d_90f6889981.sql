{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_LA_COUNTY_OPEN_D_90F6889981') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_LA_COUNTY_OPEN_D_90F6889981, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_LA_COUNTY_OPEN_D_90F6889981') }} as source
