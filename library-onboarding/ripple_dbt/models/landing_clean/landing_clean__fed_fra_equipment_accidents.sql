{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FRA_EQUIPMENT_ACCIDENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FRA_EQUIPMENT_ACCIDENTS, from the
...
select
    ...
    {{ landing_combine_time_date('"TIME"', landing_parse_date('"DATE"', 'us', 'TEXT')) }} as time_full_ts
from {{ source('ripple_raw', 'FED_FRA_EQUIPMENT_ACCIDENTS') }} as source
