{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FAC_SINGLE_AUDIT') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FAC_SINGLE_AUDIT, from the
...
select
    ...
    {{ landing_parse_date('"FAC_ACCEPTED_DATE"', 'iso', 'TEXT') }} as fac_accepted_date_clean_ts
from {{ source('ripple_raw', 'FED_FAC_SINGLE_AUDIT') }} as source
