{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_CALIFORNIA_OPEN_AD71D0FFDE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_CALIFORNIA_OPEN_AD71D0FFDE, from the
...
select
    source.*,
    {{ landing_parse_date('"STARTDATE"', 'us', 'TEXT') }} as startdate_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_CALIFORNIA_OPEN_AD71D0FFDE') }} as source
