{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_46BF1ABBC1') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_46BF1ABBC1, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_46BF1ABBC1') }} as source
