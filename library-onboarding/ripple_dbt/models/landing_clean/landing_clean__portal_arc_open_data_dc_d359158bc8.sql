{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_DC_D359158BC8') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_DC_D359158BC8, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_DC_D359158BC8') }} as source
