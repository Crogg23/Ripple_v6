{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_NAGIX_DPRK_MISSILE_TESTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_NAGIX_DPRK_MISSILE_TESTS, from the
...
from {{ source('ripple_raw', 'XC_NAGIX_DPRK_MISSILE_TESTS') }} as source
