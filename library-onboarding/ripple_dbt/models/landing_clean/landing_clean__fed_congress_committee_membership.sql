{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CONGRESS_COMMITTEE_MEMBERSHIP') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CONGRESS_COMMITTEE_MEMBERSHIP, from the
...
from {{ source('ripple_raw', 'FED_CONGRESS_COMMITTEE_MEMBERSHIP') }} as source
