{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_OCC_THRIFTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_OCC_THRIFTS, from the
...
from {{ source('ripple_raw', 'FED_OCC_THRIFTS') }} as source
