{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_EMBER_ELEC') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_EMBER_ELEC, from the
...
from {{ source('ripple_raw', 'INTL_EMBER_ELEC') }} as source
