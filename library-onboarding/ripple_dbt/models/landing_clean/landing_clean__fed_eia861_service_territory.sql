{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_SERVICE_TERRITORY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_SERVICE_TERRITORY, from the
...
from {{ source('ripple_raw', 'FED_EIA861_SERVICE_TERRITORY') }} as source
