{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_C1B203DC0A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_C1B203DC0A, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_C1B203DC0A') }} as source
