{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_NOAA_AIS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_NOAA_AIS, from the
