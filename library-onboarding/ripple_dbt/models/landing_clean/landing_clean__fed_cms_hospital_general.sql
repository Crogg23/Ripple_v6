{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_HOSPITAL_GENERAL') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_HOSPITAL_GENERAL, from the
...
from {{ source('ripple_raw', 'FED_CMS_HOSPITAL_GENERAL') }} as source
