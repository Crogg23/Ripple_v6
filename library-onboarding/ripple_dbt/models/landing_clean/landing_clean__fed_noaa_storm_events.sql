{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_NOAA_STORM_EVENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_NOAA_STORM_EVENTS, from the
...
from {{ source('ripple_raw', 'FED_NOAA_STORM_EVENTS') }} as source
