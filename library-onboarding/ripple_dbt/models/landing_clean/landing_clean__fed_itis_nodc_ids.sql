{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ITIS_NODC_IDS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ITIS_NODC_IDS, from the
...
from {{ source('ripple_raw', 'FED_ITIS_NODC_IDS') }} as source
