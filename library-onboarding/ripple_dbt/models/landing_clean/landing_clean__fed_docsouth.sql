{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_DOCSOUTH') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_DOCSOUTH, from the
...
from {{ source('ripple_raw', 'FED_DOCSOUTH') }} as source
