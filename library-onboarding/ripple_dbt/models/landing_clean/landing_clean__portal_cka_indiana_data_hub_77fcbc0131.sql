{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_INDIANA_DATA_HUB_77FCBC0131') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_INDIANA_DATA_HUB_77FCBC0131, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_INDIANA_DATA_HUB_77FCBC0131') }} as source
