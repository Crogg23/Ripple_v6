{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ITIS_EXPERTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ITIS_EXPERTS, from the
...
from {{ source('ripple_raw', 'FED_ITIS_EXPERTS') }} as source
