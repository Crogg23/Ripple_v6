{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SAM_EXCLUSIONS_FULL_R2') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SAM_EXCLUSIONS_FULL_R2, from the
...
from {{ source('ripple_raw', 'FED_SAM_EXCLUSIONS_FULL_R2') }} as source
