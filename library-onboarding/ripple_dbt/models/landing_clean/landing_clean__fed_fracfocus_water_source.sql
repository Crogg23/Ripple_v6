{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FRACFOCUS_WATER_SOURCE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FRACFOCUS_WATER_SOURCE, from the
...
from {{ source('ripple_raw', 'FED_FRACFOCUS_WATER_SOURCE') }} as source
