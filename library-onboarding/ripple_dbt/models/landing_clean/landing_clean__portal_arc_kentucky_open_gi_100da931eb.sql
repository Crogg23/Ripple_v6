{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_KENTUCKY_OPEN_GI_100DA931EB') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_KENTUCKY_OPEN_GI_100DA931EB, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_KENTUCKY_OPEN_GI_100DA931EB') }} as source
