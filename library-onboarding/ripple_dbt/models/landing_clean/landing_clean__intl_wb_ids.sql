{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_WB_IDS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_WB_IDS, from the
...
from {{ source('ripple_raw', 'INTL_WB_IDS') }} as source
