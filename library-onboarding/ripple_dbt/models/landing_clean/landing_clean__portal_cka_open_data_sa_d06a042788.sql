{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_D06A042788') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_D06A042788, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_D06A042788') }} as source
