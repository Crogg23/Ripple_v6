{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_45E7E21495') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_45E7E21495, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_45E7E21495') }} as source
