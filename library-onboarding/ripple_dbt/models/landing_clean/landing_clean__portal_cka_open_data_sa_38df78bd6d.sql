{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_38DF78BD6D') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_38DF78BD6D, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_38DF78BD6D') }} as source
