{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_DOT_BTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_DOT_BTS, from the
...
from {{ source('ripple_raw', 'FED_DOT_BTS') }} as source
