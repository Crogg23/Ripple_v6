{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_NEW_YORK_STATE_O_0C94DD2B8A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_NEW_YORK_STATE_O_0C94DD2B8A, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_NEW_YORK_STATE_O_0C94DD2B8A') }} as source
