{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_TREASURY_DEBT_TO_PENNY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_TREASURY_DEBT_TO_PENNY, from the
...
from {{ source('ripple_raw', 'FED_TREASURY_DEBT_TO_PENNY') }} as source
