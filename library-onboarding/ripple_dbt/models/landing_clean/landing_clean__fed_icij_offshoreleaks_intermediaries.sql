{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ICIJ_OFFSHORELEAKS_INTERMEDIARIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ICIJ_OFFSHORELEAKS_INTERMEDIARIES, from the
...
from {{ source('ripple_raw', 'FED_ICIJ_OFFSHORELEAKS_INTERMEDIARIES') }} as source
