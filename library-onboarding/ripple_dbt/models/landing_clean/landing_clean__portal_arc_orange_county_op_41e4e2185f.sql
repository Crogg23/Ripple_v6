{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_ORANGE_COUNTY_OP_41E4E2185F') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_ORANGE_COUNTY_OP_41E4E2185F, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_ORANGE_COUNTY_OP_41E4E2185F') }} as source
