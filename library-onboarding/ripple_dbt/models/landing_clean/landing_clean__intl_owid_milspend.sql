{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_OWID_MILSPEND') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_OWID_MILSPEND, from the
...
from {{ source('ripple_raw', 'INTL_OWID_MILSPEND') }} as source
