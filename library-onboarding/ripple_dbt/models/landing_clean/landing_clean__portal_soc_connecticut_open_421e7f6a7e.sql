{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_CONNECTICUT_OPEN_421E7F6A7E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_CONNECTICUT_OPEN_421E7F6A7E, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_CONNECTICUT_OPEN_421E7F6A7E') }} as source
