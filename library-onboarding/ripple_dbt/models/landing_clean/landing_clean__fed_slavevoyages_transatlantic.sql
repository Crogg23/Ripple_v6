{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SLAVEVOYAGES_TRANSATLANTIC') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SLAVEVOYAGES_TRANSATLANTIC, from the
...
from {{ source('ripple_raw', 'FED_SLAVEVOYAGES_TRANSATLANTIC') }} as source
