{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_DHS_OHSS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_DHS_OHSS, from the
...
from {{ source('ripple_raw', 'FED_DHS_OHSS') }} as source
