{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_IRELAND_NATIONAL_F340FB5CBD') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_IRELAND_NATIONAL_F340FB5CBD, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_IRELAND_NATIONAL_F340FB5CBD') }} as source
