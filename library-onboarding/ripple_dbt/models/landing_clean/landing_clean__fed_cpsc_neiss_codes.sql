{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CPSC_NEISS_CODES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CPSC_NEISS_CODES, from the
...
from {{ source('ripple_raw', 'FED_CPSC_NEISS_CODES') }} as source
