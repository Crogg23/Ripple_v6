{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_FOSSIL_SHARE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_FOSSIL_SHARE, from the
...
from {{ source('ripple_raw', 'XC_OWID_FOSSIL_SHARE') }} as source
