{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_NCUA_CALL_REPORTS_FS220') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_NCUA_CALL_REPORTS_FS220, from the
...
select
    ...
    {{ landing_parse_date('"UPDATE_DATE"', 'us', 'TEXT') }} as update_date_clean_ts,
    {{ landing_parse_audit_epoch('"_INGESTED_AT"') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'FED_NCUA_CALL_REPORTS_FS220') }} as source
