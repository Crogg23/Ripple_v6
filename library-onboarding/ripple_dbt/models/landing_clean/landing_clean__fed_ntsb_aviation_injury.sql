{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_NTSB_AVIATION_INJURY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_NTSB_AVIATION_INJURY, from the
...
from {{ source('ripple_raw', 'FED_NTSB_AVIATION_INJURY') }} as source
