{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_TREASURY_DTS_DEPOSITS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_TREASURY_DTS_DEPOSITS, from the
...
from {{ source('ripple_raw', 'FED_TREASURY_DTS_DEPOSITS') }} as source
