{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OKLAHOMA_OPEN_DA_C96BA4E090') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OKLAHOMA_OPEN_DA_C96BA4E090, from the
...
select
    source.*,
    {{ landing_parse_date('"INITIAL_OCCUPANCY"', 'us', 'TEXT') }} as initial_occupancy_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_OKLAHOMA_OPEN_DA_C96BA4E090') }} as source
