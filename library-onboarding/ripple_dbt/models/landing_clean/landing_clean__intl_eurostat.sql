{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_EUROSTAT') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_EUROSTAT, from the
...
from {{ source('ripple_raw', 'INTL_EUROSTAT') }} as source
