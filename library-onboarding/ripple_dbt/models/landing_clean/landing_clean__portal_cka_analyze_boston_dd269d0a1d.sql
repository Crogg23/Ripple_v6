{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_DD269D0A1D') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_DD269D0A1D, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_DD269D0A1D') }} as source
