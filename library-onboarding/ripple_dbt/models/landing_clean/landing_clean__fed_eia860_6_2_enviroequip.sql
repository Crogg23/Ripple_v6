{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA860_6_2_ENVIROEQUIP') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA860_6_2_ENVIROEQUIP, from the
...
from {{ source('ripple_raw', 'FED_EIA860_6_2_ENVIROEQUIP') }} as source
