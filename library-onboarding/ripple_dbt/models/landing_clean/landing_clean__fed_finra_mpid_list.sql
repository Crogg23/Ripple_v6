{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FINRA_MPID_LIST') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FINRA_MPID_LIST, from the
...
from {{ source('ripple_raw', 'FED_FINRA_MPID_LIST') }} as source
