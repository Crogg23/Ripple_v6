{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OKLAHOMA_OPEN_DA_2A27DEA617') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OKLAHOMA_OPEN_DA_2A27DEA617, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OKLAHOMA_OPEN_DA_2A27DEA617') }} as source
