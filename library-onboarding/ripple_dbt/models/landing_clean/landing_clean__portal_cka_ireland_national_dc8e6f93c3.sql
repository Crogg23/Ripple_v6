{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_IRELAND_NATIONAL_DC8E6F93C3') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_IRELAND_NATIONAL_DC8E6F93C3, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_IRELAND_NATIONAL_DC8E6F93C3') }} as source
