{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_FRS_FRS_FACILITIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_FRS_FRS_FACILITIES, from the
...
from {{ source('ripple_raw', 'FED_EPA_FRS_FRS_FACILITIES') }} as source
