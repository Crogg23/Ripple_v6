{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_SAN_JOSE_OPEN_DA_876760587A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_SAN_JOSE_OPEN_DA_876760587A, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_SAN_JOSE_OPEN_DA_876760587A') }} as source
