{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_WASHINGTON_STATE_48EEEF5DFC') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_WASHINGTON_STATE_48EEEF5DFC, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_WASHINGTON_STATE_48EEEF5DFC') }} as source
