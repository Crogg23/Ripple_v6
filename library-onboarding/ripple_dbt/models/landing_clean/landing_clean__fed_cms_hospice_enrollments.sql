{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_HOSPICE_ENROLLMENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_HOSPICE_ENROLLMENTS, from the
...
from {{ source('ripple_raw', 'FED_CMS_HOSPICE_ENROLLMENTS') }} as source
