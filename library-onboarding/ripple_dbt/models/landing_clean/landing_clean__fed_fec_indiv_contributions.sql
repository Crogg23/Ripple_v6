{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FEC_INDIV_CONTRIBUTIONS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FEC_INDIV_CONTRIBUTIONS, from the
...
from {{ source('ripple_raw', 'FED_FEC_INDIV_CONTRIBUTIONS') }} as source
