{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_DISTRIBUTION_SYSTEMS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_DISTRIBUTION_SYSTEMS, from the
...
from {{ source('ripple_raw', 'FED_EIA861_DISTRIBUTION_SYSTEMS') }} as source
