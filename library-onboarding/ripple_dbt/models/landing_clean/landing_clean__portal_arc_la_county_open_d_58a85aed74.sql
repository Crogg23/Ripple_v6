{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_LA_COUNTY_OPEN_D_58A85AED74') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_LA_COUNTY_OPEN_D_58A85AED74, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_LA_COUNTY_OPEN_D_58A85AED74') }} as source
