{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_USCG_NRC_INCIDENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_USCG_NRC_INCIDENTS, from the
...
from {{ source('ripple_raw', 'FED_USCG_NRC_INCIDENTS') }} as source
