{{ config(materialized='view', schema='LANDING_CLEAN', alias='IRS527_DIRECTORS_OFFICERS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.IRS527_DIRECTORS_OFFICERS, from the
...
from {{ source('ripple_raw', 'IRS527_DIRECTORS_OFFICERS') }} as source
