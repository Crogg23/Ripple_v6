{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_WISCONSIN_OPEN_D_5206358BDD') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_WISCONSIN_OPEN_D_5206358BDD, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_WISCONSIN_OPEN_D_5206358BDD') }} as source
