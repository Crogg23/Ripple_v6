{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_CL_DATOSGOB') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_CL_DATOSGOB, from the
...
from {{ source('ripple_raw', 'INTL_CL_DATOSGOB') }} as source
