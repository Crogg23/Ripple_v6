{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_USCOURTS_STATS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_USCOURTS_STATS, from the
...
from {{ source('ripple_raw', 'FED_USCOURTS_STATS') }} as source
