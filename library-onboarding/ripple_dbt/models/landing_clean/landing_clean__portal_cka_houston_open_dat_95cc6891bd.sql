{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_HOUSTON_OPEN_DAT_95CC6891BD') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_HOUSTON_OPEN_DAT_95CC6891BD, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_HOUSTON_OPEN_DAT_95CC6891BD') }} as source
