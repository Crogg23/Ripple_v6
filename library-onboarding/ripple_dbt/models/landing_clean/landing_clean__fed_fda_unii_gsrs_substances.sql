{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FDA_UNII_GSRS_SUBSTANCES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FDA_UNII_GSRS_SUBSTANCES, from the
...
from {{ source('ripple_raw', 'FED_FDA_UNII_GSRS_SUBSTANCES') }} as source
