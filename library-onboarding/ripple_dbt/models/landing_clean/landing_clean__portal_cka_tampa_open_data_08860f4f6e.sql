{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_TAMPA_OPEN_DATA_08860F4F6E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_TAMPA_OPEN_DATA_08860F4F6E, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_TAMPA_OPEN_DATA_08860F4F6E') }} as source
