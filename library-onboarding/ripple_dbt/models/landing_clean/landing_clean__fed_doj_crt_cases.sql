{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_DOJ_CRT_CASES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_DOJ_CRT_CASES, from the
...
from {{ source('ripple_raw', 'FED_DOJ_CRT_CASES') }} as source
