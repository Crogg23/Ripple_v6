{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_75596F44E9') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_75596F44E9, from the
...
select
    source.*,
    {{ landing_parse_date('"TERMSEFFEC"', 'us', 'TEXT') }} as termseffec_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_75596F44E9') }} as source
