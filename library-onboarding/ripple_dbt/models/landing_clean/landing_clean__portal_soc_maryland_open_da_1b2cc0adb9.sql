{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_MARYLAND_OPEN_DA_1B2CC0ADB9') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_MARYLAND_OPEN_DA_1B2CC0ADB9, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_MARYLAND_OPEN_DA_1B2CC0ADB9') }} as source
