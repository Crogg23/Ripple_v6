{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_WPRDC_ALLEGHENY_DE448D04D4') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_WPRDC_ALLEGHENY_DE448D04D4, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_WPRDC_ALLEGHENY_DE448D04D4') }} as source
