{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_HUD_DATA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_HUD_DATA, from the
...
from {{ source('ripple_raw', 'FED_HUD_DATA') }} as source
