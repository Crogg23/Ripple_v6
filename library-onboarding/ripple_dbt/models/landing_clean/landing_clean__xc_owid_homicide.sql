{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_HOMICIDE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_HOMICIDE, from the
...
from {{ source('ripple_raw', 'XC_OWID_HOMICIDE') }} as source
