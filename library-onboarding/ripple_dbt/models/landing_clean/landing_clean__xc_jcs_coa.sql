{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_JCS_COA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_JCS_COA, from the
...
from {{ source('ripple_raw', 'XC_JCS_COA') }} as source
