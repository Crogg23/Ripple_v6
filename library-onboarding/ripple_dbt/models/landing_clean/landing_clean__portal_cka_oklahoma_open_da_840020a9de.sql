{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OKLAHOMA_OPEN_DA_840020A9DE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OKLAHOMA_OPEN_DA_840020A9DE, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OKLAHOMA_OPEN_DA_840020A9DE') }} as source
