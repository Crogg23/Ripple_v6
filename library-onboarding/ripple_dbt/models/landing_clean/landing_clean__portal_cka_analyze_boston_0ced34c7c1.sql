{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_0CED34C7C1') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_0CED34C7C1, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_0CED34C7C1') }} as source
