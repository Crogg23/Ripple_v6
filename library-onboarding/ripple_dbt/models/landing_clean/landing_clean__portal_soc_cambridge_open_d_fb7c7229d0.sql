{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_CAMBRIDGE_OPEN_D_FB7C7229D0') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_CAMBRIDGE_OPEN_D_FB7C7229D0, from the
...
select
    source.*,
    {{ landing_parse_date('"DATA_CURRENT_AS_OF"', 'iso', 'TEXT') }} as data_current_as_of_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_SOC_CAMBRIDGE_OPEN_D_FB7C7229D0') }} as source
