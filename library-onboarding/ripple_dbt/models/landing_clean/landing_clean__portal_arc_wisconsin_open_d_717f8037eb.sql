{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_WISCONSIN_OPEN_D_717F8037EB') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_WISCONSIN_OPEN_D_717F8037EB, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_WISCONSIN_OPEN_D_717F8037EB') }} as source
