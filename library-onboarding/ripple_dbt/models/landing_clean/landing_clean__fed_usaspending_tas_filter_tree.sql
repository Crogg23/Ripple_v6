{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_USASPENDING_TAS_FILTER_TREE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_USASPENDING_TAS_FILTER_TREE, from the
...
from {{ source('ripple_raw', 'FED_USASPENDING_TAS_FILTER_TREE') }} as source
