{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ITIS_TU_COMMENTS_LINKS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ITIS_TU_COMMENTS_LINKS, from the
...
from {{ source('ripple_raw', 'FED_ITIS_TU_COMMENTS_LINKS') }} as source
