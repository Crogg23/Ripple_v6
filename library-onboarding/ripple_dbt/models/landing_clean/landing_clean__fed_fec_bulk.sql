{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FEC_BULK') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FEC_BULK, from the
...
from {{ source('ripple_raw', 'FED_FEC_BULK') }} as source
