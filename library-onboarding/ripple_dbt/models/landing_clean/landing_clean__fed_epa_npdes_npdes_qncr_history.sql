{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_NPDES_NPDES_QNCR_HISTORY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_NPDES_NPDES_QNCR_HISTORY, from the
...
from {{ source('ripple_raw', 'FED_EPA_NPDES_NPDES_QNCR_HISTORY') }} as source
