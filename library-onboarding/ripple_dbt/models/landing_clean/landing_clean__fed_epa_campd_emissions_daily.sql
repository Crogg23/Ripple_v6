{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_CAMPD_EMISSIONS_DAILY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_CAMPD_EMISSIONS_DAILY, from the
...
from {{ source('ripple_raw', 'FED_EPA_CAMPD_EMISSIONS_DAILY') }} as source
