{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_DB29EC5366') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_DB29EC5366, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_DB29EC5366') }} as source
