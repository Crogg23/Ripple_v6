{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_VIRGINIA_OPEN_DA_AC3869EE0E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_VIRGINIA_OPEN_DA_AC3869EE0E, from the
...
select
    source.*,
    {{ landing_parse_date('"DATE_TRAN"', 'us', 'TEXT') }} as date_tran_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_VIRGINIA_OPEN_DA_AC3869EE0E') }} as source
