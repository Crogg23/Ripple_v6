{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_DELAWARE_OPEN_DA_D15606CF5C') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_DELAWARE_OPEN_DA_D15606CF5C, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_DELAWARE_OPEN_DA_D15606CF5C') }} as source
