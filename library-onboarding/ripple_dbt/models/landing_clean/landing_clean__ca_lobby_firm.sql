{{ config(materialized='view', schema='LANDING_CLEAN', alias='CA_LOBBY_FIRM') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.CA_LOBBY_FIRM, from the
...
from {{ source('ripple_raw', 'CA_LOBBY_FIRM') }} as source
