{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA_860_GENERATOR') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA_860_GENERATOR, from the
...
from {{ source('ripple_raw', 'FED_EIA_860_GENERATOR') }} as source
