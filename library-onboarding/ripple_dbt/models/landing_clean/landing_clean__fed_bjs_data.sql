{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_BJS_DATA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_BJS_DATA, from the
...
from {{ source('ripple_raw', 'FED_BJS_DATA') }} as source
