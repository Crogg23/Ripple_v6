{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_E2B711DB0F') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_E2B711DB0F, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_E2B711DB0F') }} as source
