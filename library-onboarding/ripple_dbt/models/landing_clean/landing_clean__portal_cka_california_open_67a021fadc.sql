{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_CALIFORNIA_OPEN_67A021FADC') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_CALIFORNIA_OPEN_67A021FADC, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_CALIFORNIA_OPEN_67A021FADC') }} as source
