{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ISRAEL_NATIONAL_D4F3080D38') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ISRAEL_NATIONAL_D4F3080D38, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ISRAEL_NATIONAL_D4F3080D38') }} as source
