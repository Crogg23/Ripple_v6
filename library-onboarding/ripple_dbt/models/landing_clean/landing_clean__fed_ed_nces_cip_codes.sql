{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ED_NCES_CIP_CODES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ED_NCES_CIP_CODES, from the
...
from {{ source('ripple_raw', 'FED_ED_NCES_CIP_CODES') }} as source
