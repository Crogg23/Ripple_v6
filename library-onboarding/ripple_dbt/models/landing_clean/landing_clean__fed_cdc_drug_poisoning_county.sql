{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CDC_DRUG_POISONING_COUNTY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CDC_DRUG_POISONING_COUNTY, from the
...
from {{ source('ripple_raw', 'FED_CDC_DRUG_POISONING_COUNTY') }} as source
