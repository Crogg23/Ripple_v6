{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_CALIFORNIA_OPEN_72414C64DF') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_CALIFORNIA_OPEN_72414C64DF, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_CALIFORNIA_OPEN_72414C64DF') }} as source
