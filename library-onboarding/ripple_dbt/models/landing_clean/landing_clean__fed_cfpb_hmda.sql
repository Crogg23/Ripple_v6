{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CFPB_HMDA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CFPB_HMDA, from the
...
from {{ source('ripple_raw', 'FED_CFPB_HMDA') }} as source
