{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_FAO_FAOSTAT_FOOD_SECURITY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_FAO_FAOSTAT_FOOD_SECURITY, from the
...
from {{ source('ripple_raw', 'INTL_FAO_FAOSTAT_FOOD_SECURITY') }} as source
