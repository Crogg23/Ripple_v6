{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_OSFI_REGULATED_FI') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_OSFI_REGULATED_FI, from the
...
from {{ source('ripple_raw', 'INTL_OSFI_REGULATED_FI') }} as source
