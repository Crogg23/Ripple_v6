{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_HOUSTON_OPEN_DAT_EBCDF36B9E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_HOUSTON_OPEN_DAT_EBCDF36B9E, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_HOUSTON_OPEN_DAT_EBCDF36B9E') }} as source
