{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_COURTLISTENER_FINANCIAL_DISCLOSURES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_COURTLISTENER_FINANCIAL_DISCLOSURES, from the
...
from {{ source('ripple_raw', 'FED_COURTLISTENER_FINANCIAL_DISCLOSURES') }} as source
