{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_LOUISVILLE_OPEN_B5DAB97E2B') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_LOUISVILLE_OPEN_B5DAB97E2B, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_LOUISVILLE_OPEN_B5DAB97E2B') }} as source
