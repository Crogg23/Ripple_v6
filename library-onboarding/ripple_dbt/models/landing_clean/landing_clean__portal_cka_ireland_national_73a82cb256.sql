{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_IRELAND_NATIONAL_73A82CB256') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_IRELAND_NATIONAL_73A82CB256, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_IRELAND_NATIONAL_73A82CB256') }} as source
