{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_SALES_ULT_CUST') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_SALES_ULT_CUST, from the
...
from {{ source('ripple_raw', 'FED_EIA861_SALES_ULT_CUST') }} as source
