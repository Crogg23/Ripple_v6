{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_ENERGY_EFFICIENCY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_ENERGY_EFFICIENCY, from the
...
from {{ source('ripple_raw', 'FED_EIA861_ENERGY_EFFICIENCY') }} as source
