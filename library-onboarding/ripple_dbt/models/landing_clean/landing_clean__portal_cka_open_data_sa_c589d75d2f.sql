{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_C589D75D2F') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_C589D75D2F, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_C589D75D2F') }} as source
