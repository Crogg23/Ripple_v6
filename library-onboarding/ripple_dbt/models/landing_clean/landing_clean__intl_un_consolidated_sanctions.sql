{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_UN_CONSOLIDATED_SANCTIONS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_UN_CONSOLIDATED_SANCTIONS, from the
...
from {{ source('ripple_raw', 'INTL_UN_CONSOLIDATED_SANCTIONS') }} as source
