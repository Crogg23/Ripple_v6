{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_992876D5AB') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_992876D5AB, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_992876D5AB') }} as source
