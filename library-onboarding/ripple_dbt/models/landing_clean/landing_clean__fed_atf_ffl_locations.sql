{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ATF_FFL_LOCATIONS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ATF_FFL_LOCATIONS, from the
...
from {{ source('ripple_raw', 'FED_ATF_FFL_LOCATIONS') }} as source
