{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_NTSB_AVIATION_EVENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_NTSB_AVIATION_EVENTS, from the
...
from {{ source('ripple_raw', 'FED_NTSB_AVIATION_EVENTS') }} as source
