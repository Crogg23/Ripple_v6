{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_INDIANA_DATA_HUB_90819D705E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_INDIANA_DATA_HUB_90819D705E, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_INDIANA_DATA_HUB_90819D705E') }} as source
