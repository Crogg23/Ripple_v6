{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_COLORADO_INFORMA_F0E162D7A8') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_COLORADO_INFORMA_F0E162D7A8, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_COLORADO_INFORMA_F0E162D7A8') }} as source
