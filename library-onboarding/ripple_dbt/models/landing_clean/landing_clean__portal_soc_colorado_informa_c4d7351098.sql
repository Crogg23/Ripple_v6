{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_COLORADO_INFORMA_C4D7351098') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_COLORADO_INFORMA_C4D7351098, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_COLORADO_INFORMA_C4D7351098') }} as source
