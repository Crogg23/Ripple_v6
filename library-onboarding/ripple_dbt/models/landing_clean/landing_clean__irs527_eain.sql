{{ config(materialized='view', schema='LANDING_CLEAN', alias='IRS527_EAIN') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.IRS527_EAIN, from the
...
from {{ source('ripple_raw', 'IRS527_EAIN') }} as source
