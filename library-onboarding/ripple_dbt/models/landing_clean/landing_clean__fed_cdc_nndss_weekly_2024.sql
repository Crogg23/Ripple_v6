{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CDC_NNDSS_WEEKLY_2024') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CDC_NNDSS_WEEKLY_2024, from the
...
from {{ source('ripple_raw', 'FED_CDC_NNDSS_WEEKLY_2024') }} as source
