{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_COURTLISTENER_ORAL_ARGUMENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_COURTLISTENER_ORAL_ARGUMENTS, from the
...
from {{ source('ripple_raw', 'FED_COURTLISTENER_ORAL_ARGUMENTS') }} as source
