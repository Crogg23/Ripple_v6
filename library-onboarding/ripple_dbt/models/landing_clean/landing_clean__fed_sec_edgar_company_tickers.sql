{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SEC_EDGAR_COMPANY_TICKERS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SEC_EDGAR_COMPANY_TICKERS, from the
...
from {{ source('ripple_raw', 'FED_SEC_EDGAR_COMPANY_TICKERS') }} as source
