{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_PBGC_DATA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_PBGC_DATA, from the
...
from {{ source('ripple_raw', 'FED_PBGC_DATA') }} as source
