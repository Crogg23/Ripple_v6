{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_VERMONT_OPEN_GEO_DE261D6F8C') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_VERMONT_OPEN_GEO_DE261D6F8C, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_VERMONT_OPEN_GEO_DE261D6F8C') }} as source
