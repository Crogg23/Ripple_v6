{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_CO2') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_CO2, from the
...
from {{ source('ripple_raw', 'XC_OWID_CO2') }} as source
