{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_GR_GEMI') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_GR_GEMI, from the
...
from {{ source('ripple_raw', 'INTL_GR_GEMI') }} as source
