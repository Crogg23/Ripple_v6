{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_USGS_WATER') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_USGS_WATER, from the
...
from {{ source('ripple_raw', 'FED_USGS_WATER') }} as source
