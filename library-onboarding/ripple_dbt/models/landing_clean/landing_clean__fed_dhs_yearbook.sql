{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_DHS_YEARBOOK') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_DHS_YEARBOOK, from the
...
from {{ source('ripple_raw', 'FED_DHS_YEARBOOK') }} as source
