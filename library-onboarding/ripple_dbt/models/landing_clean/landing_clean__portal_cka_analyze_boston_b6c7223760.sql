{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_B6C7223760') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_B6C7223760, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_B6C7223760') }} as source
