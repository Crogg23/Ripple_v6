{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_721BEBB7DF') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_721BEBB7DF, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_721BEBB7DF') }} as source
