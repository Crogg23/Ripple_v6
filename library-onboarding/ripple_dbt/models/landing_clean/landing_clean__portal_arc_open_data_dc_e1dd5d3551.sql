{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_DC_E1DD5D3551') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_DC_E1DD5D3551, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_DC_E1DD5D3551') }} as source
