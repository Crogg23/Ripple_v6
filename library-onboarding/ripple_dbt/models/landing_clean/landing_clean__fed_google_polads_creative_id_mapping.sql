{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_GOOGLE_POLADS_CREATIVE_ID_MAPPING') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_GOOGLE_POLADS_CREATIVE_ID_MAPPING, from the
...
from {{ source('ripple_raw', 'FED_GOOGLE_POLADS_CREATIVE_ID_MAPPING') }} as source
