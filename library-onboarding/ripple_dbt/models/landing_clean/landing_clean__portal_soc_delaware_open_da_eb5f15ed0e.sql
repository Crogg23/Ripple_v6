{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_DELAWARE_OPEN_DA_EB5F15ED0E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_DELAWARE_OPEN_DA_EB5F15ED0E, from the
...
select
    source.*,
    {{ landing_parse_date('"UPDATED"', 'iso', 'TEXT') }} as updated_clean_ts,
...
from {{ source('ripple_raw', 'PORTAL_SOC_DELAWARE_OPEN_DA_EB5F15ED0E') }} as source
