{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_HUDOC') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_HUDOC, from the
...
from {{ source('ripple_raw', 'INTL_HUDOC') }} as source
