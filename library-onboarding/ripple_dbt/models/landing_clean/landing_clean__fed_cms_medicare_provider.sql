{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_MEDICARE_PROVIDER') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_MEDICARE_PROVIDER, from the
...
from {{ source('ripple_raw', 'FED_CMS_MEDICARE_PROVIDER') }} as source
