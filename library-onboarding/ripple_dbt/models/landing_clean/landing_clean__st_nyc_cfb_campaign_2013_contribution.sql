{{ config(materialized='view', schema='LANDING_CLEAN', alias='ST_NYC_CFB_CAMPAIGN_2013_CONTRIBUTION') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.ST_NYC_CFB_CAMPAIGN_2013_CONTRIBUTION, from the
...
from {{ source('ripple_raw', 'ST_NYC_CFB_CAMPAIGN_2013_CONTRIBUTION') }} as source
