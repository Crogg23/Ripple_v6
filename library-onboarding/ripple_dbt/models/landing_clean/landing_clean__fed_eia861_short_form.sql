{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_SHORT_FORM') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_SHORT_FORM, from the
...
from {{ source('ripple_raw', 'FED_EIA861_SHORT_FORM') }} as source
