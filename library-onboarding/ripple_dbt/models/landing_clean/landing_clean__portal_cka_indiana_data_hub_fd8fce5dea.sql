{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_INDIANA_DATA_HUB_FD8FCE5DEA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_INDIANA_DATA_HUB_FD8FCE5DEA, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_INDIANA_DATA_HUB_FD8FCE5DEA') }} as source
