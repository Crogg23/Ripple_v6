{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FAA_DATA_PORTAL') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FAA_DATA_PORTAL, from the
...
from {{ source('ripple_raw', 'FED_FAA_DATA_PORTAL') }} as source
