{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_7073B94B84') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_7073B94B84, from the
...
select
    ...
    {{ landing_parse_date('"DATE_FOUNDED"', 'us', 'TEXT') }} as date_founded_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_7073B94B84') }} as source
