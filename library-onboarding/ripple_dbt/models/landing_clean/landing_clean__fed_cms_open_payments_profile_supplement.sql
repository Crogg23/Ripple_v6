{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_OPEN_PAYMENTS_PROFILE_SUPPLEMENT') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_OPEN_PAYMENTS_PROFILE_SUPPLEMENT, from the
...
from {{ source('ripple_raw', 'FED_CMS_OPEN_PAYMENTS_PROFILE_SUPPLEMENT') }} as source
