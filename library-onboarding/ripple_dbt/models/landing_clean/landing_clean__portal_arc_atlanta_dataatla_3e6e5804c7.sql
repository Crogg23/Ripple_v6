{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_ATLANTA_DATAATLA_3E6E5804C7') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_ATLANTA_DATAATLA_3E6E5804C7, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_ATLANTA_DATAATLA_3E6E5804C7') }} as source
