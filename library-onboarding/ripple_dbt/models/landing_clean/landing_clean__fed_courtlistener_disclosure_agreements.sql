{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_COURTLISTENER_DISCLOSURE_AGREEMENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_COURTLISTENER_DISCLOSURE_AGREEMENTS, from the
...
from {{ source('ripple_raw', 'FED_COURTLISTENER_DISCLOSURE_AGREEMENTS') }} as source
