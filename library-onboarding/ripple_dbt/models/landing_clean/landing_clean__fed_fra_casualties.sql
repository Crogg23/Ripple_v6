{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FRA_CASUALTIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FRA_CASUALTIES, from the
...
from {{ source('ripple_raw', 'FED_FRA_CASUALTIES') }} as source
