{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_VOTEVIEW_MEMBERS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_VOTEVIEW_MEMBERS, from the
...
from {{ source('ripple_raw', 'FED_VOTEVIEW_MEMBERS') }} as source
