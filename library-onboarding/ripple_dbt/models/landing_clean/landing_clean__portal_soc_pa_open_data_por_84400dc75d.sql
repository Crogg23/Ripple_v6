{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_PA_OPEN_DATA_POR_84400DC75D') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_PA_OPEN_DATA_POR_84400DC75D, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_PA_OPEN_DATA_POR_84400DC75D') }} as source
