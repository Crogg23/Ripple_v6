{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_NET_METERING') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_NET_METERING, from the
...
from {{ source('ripple_raw', 'FED_EIA861_NET_METERING') }} as source
