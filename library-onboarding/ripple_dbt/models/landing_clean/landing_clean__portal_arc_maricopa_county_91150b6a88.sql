{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_MARICOPA_COUNTY_91150B6A88') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_MARICOPA_COUNTY_91150B6A88, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_MARICOPA_COUNTY_91150B6A88') }} as source
