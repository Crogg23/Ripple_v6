{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_GOOGLE_POLADS_GEO_SPEND') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_GOOGLE_POLADS_GEO_SPEND, from the
...
from {{ source('ripple_raw', 'FED_GOOGLE_POLADS_GEO_SPEND') }} as source
