{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_IRELAND_NATIONAL_12F7EAE1D9') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_IRELAND_NATIONAL_12F7EAE1D9, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_IRELAND_NATIONAL_12F7EAE1D9') }} as source
