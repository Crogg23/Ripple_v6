{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_GH_DATAGOVGH') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_GH_DATAGOVGH, from the
...
from {{ source('ripple_raw', 'INTL_GH_DATAGOVGH') }} as source
