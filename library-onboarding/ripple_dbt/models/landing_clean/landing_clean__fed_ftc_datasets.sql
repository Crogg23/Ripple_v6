{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FTC_DATASETS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FTC_DATASETS, from the
...
from {{ source('ripple_raw', 'FED_FTC_DATASETS') }} as source
