{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_MARYLAND_OPEN_DA_7CE817C5CE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_MARYLAND_OPEN_DA_7CE817C5CE, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_MARYLAND_OPEN_DA_7CE817C5CE') }} as source
