{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SEC_BUSINESS_DEVELOPMENT_COMPANY_REPORT') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SEC_BUSINESS_DEVELOPMENT_COMPANY_REPORT, from the
...
from {{ source('ripple_raw', 'FED_SEC_BUSINESS_DEVELOPMENT_COMPANY_REPORT') }} as source
