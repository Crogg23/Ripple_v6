{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_8A02CA5E02') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_8A02CA5E02, from the
...
select
    source.*,
    {{ landing_parse_date('"PLANNED_INSTALL_DATE"', 'us', 'TEXT') }} as planned_install_date_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_8A02CA5E02') }} as source
