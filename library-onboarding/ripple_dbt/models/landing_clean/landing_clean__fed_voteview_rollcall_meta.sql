{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_VOTEVIEW_ROLLCALL_META') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_VOTEVIEW_ROLLCALL_META, from the
...
from {{ source('ripple_raw', 'FED_VOTEVIEW_ROLLCALL_META') }} as source
