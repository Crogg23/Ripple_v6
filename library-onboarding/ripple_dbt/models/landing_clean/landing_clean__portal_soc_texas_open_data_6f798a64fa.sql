{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_TEXAS_OPEN_DATA_6F798A64FA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_TEXAS_OPEN_DATA_6F798A64FA, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_TEXAS_OPEN_DATA_6F798A64FA') }} as source
