{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_OREGON_OPEN_DATA_072D0C4A94') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_OREGON_OPEN_DATA_072D0C4A94, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_OREGON_OPEN_DATA_072D0C4A94') }} as source
