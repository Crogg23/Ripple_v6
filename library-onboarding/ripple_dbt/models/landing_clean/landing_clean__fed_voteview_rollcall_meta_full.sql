{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_VOTEVIEW_ROLLCALL_META_FULL') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_VOTEVIEW_ROLLCALL_META_FULL, from the
...
from {{ source('ripple_raw', 'FED_VOTEVIEW_ROLLCALL_META_FULL') }} as source
