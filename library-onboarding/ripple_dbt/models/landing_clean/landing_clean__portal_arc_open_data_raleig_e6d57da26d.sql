{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_RALEIG_E6D57DA26D') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_RALEIG_E6D57DA26D, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_RALEIG_E6D57DA26D') }} as source
