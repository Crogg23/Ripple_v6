{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_NEW_YORK_STATE_O_4A5291BE83') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_NEW_YORK_STATE_O_4A5291BE83, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_NEW_YORK_STATE_O_4A5291BE83') }} as source
