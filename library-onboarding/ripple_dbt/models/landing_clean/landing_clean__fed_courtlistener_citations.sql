{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_COURTLISTENER_CITATIONS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_COURTLISTENER_CITATIONS, from the
...
from {{ source('ripple_raw', 'FED_COURTLISTENER_CITATIONS') }} as source
