{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_HARRIS_COUNTY_OP_2A7A02B1E2') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_HARRIS_COUNTY_OP_2A7A02B1E2, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_HARRIS_COUNTY_OP_2A7A02B1E2') }} as source
