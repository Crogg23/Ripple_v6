{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_HUD_PUBLIC_HOUSING_AUTHORITIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_HUD_PUBLIC_HOUSING_AUTHORITIES, from the
...
from {{ source('ripple_raw', 'FED_HUD_PUBLIC_HOUSING_AUTHORITIES') }} as source
