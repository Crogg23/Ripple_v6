{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_NHTSA_RECALLS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_NHTSA_RECALLS, from the
...
select
    source.*,
    {{ landing_parse_date('"C9"', 'ymd8', 'TEXT') }} as c9_clean_ts,
    {{ landing_parse_date('"C10"', 'ymd8', 'TEXT') }} as c10_clean_ts,
    {{ landing_parse_date('"C13"', 'ymd8', 'TEXT') }} as c13_clean_ts,
    {{ landing_parse_date('"C16"', 'ymd8', 'TEXT') }} as c16_clean_ts,
    {{ landing_parse_date('"C17"', 'ymd8', 'TEXT') }} as c17_clean_ts
from {{ source('ripple_raw', 'FED_NHTSA_RECALLS') }} as source
