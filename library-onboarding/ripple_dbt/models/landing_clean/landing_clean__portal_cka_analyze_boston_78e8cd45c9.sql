{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_78E8CD45C9') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_78E8CD45C9, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_78E8CD45C9') }} as source
