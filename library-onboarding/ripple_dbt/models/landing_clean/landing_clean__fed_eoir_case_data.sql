{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EOIR_CASE_DATA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EOIR_CASE_DATA, from the
...
from {{ source('ripple_raw', 'FED_EOIR_CASE_DATA') }} as source
