{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_B4C5E99B0A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_B4C5E99B0A, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_B4C5E99B0A') }} as source
