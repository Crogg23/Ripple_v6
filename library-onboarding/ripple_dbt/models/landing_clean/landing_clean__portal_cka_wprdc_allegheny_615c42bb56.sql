{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_WPRDC_ALLEGHENY_615C42BB56') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_WPRDC_ALLEGHENY_615C42BB56, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_WPRDC_ALLEGHENY_615C42BB56') }} as source
