{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_SAN_JOSE_OPEN_DA_30D54CBFB9') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_SAN_JOSE_OPEN_DA_30D54CBFB9, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_SAN_JOSE_OPEN_DA_30D54CBFB9') }} as source
