{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_ATLANTA_DATAATLA_D6C1E3B844') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_ATLANTA_DATAATLA_D6C1E3B844, from the
...
select
    source.*,
    {{ landing_parse_date('"C_START"', 'iso', 'TEXT') }} as c_start_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_ARC_ATLANTA_DATAATLA_D6C1E3B844') }} as source
