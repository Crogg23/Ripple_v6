{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_OFAC_SDN') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_OFAC_SDN, from the
...
from {{ source('ripple_raw', 'FED_OFAC_SDN') }} as source
