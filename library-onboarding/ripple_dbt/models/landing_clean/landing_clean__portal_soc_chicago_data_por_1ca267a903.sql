{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_CHICAGO_DATA_POR_1CA267A903') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_CHICAGO_DATA_POR_1CA267A903, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_CHICAGO_DATA_POR_1CA267A903') }} as source
