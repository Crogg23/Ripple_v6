{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_WPRDC_ALLEGHENY_63627B65F8') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_WPRDC_ALLEGHENY_63627B65F8, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_WPRDC_ALLEGHENY_63627B65F8') }} as source
