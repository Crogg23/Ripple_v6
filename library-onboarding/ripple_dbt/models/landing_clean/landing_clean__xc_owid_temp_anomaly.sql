{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_TEMP_ANOMALY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_TEMP_ANOMALY, from the
...
from {{ source('ripple_raw', 'XC_OWID_TEMP_ANOMALY') }} as source
