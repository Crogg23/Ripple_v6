{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_HOUSTON_OPEN_DAT_19CBD263CC') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_HOUSTON_OPEN_DAT_19CBD263CC, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_HOUSTON_OPEN_DAT_19CBD263CC') }} as source
