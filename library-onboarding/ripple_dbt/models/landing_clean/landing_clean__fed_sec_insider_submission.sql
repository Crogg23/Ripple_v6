{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SEC_INSIDER_SUBMISSION') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SEC_INSIDER_SUBMISSION, from the
...
from {{ source('ripple_raw', 'FED_SEC_INSIDER_SUBMISSION') }} as source
