{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ATF_FFL') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ATF_FFL, from the
...
from {{ source('ripple_raw', 'FED_ATF_FFL') }} as source
