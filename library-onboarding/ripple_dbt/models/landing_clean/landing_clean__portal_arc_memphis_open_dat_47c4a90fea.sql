{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_MEMPHIS_OPEN_DAT_47C4A90FEA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_MEMPHIS_OPEN_DAT_47C4A90FEA, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_MEMPHIS_OPEN_DAT_47C4A90FEA') }} as source
