{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CFPB_HMDA_LAR') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CFPB_HMDA_LAR, from the
...
from {{ source('ripple_raw', 'FED_CFPB_HMDA_LAR') }} as source
