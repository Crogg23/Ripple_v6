{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_VIRGINIA_OPEN_DA_F11E52D4B6') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_VIRGINIA_OPEN_DA_F11E52D4B6, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_VIRGINIA_OPEN_DA_F11E52D4B6') }} as source
