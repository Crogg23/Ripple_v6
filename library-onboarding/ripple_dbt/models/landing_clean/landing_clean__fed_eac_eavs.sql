{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EAC_EAVS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EAC_EAVS, from the
...
from {{ source('ripple_raw', 'FED_EAC_EAVS') }} as source
