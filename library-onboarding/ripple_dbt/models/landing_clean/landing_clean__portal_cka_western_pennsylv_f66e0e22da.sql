{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_WESTERN_PENNSYLV_F66E0E22DA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_WESTERN_PENNSYLV_F66E0E22DA, from the
...
select
    source.*,
    {{ landing_parse_date('"APP_DATE"', 'iso', 'TEXT') }} as app_date_clean_ts,
    {{ landing_parse_date('"APP_SORT"', 'ymd8', 'TEXT') }} as app_sort_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_WESTERN_PENNSYLV_F66E0E22DA') }} as source
