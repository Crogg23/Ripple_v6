{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_CAMBRIDGE_OPEN_D_D1389AFE1E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_CAMBRIDGE_OPEN_D_D1389AFE1E, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_CAMBRIDGE_OPEN_D_D1389AFE1E') }} as source
