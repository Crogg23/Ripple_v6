{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_CE75F7FDDE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_CE75F7FDDE, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_CE75F7FDDE') }} as source
