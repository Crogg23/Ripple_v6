{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_ES_DATOSGOB') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_ES_DATOSGOB, from the
...
from {{ source('ripple_raw', 'INTL_ES_DATOSGOB') }} as source
