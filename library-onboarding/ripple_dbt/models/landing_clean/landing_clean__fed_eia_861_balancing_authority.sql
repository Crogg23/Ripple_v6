{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA_861_BALANCING_AUTHORITY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA_861_BALANCING_AUTHORITY, from the
...
from {{ source('ripple_raw', 'FED_EIA_861_BALANCING_AUTHORITY') }} as source
