{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FHFA_HPI') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FHFA_HPI, from the
...
from {{ source('ripple_raw', 'FED_FHFA_HPI') }} as source
