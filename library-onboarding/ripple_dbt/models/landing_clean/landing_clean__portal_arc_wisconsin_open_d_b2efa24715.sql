{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_WISCONSIN_OPEN_D_B2EFA24715') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_WISCONSIN_OPEN_D_B2EFA24715, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_WISCONSIN_OPEN_D_B2EFA24715') }} as source
