{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_LIFE_EXPECTANCY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_LIFE_EXPECTANCY, from the
...
from {{ source('ripple_raw', 'XC_OWID_LIFE_EXPECTANCY') }} as source
