{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_COLOMBIA_NATIONA_3C8F38B720') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_COLOMBIA_NATIONA_3C8F38B720, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_COLOMBIA_NATIONA_3C8F38B720') }} as source
