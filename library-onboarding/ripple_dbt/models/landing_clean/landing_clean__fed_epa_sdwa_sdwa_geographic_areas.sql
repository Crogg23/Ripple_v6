{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_SDWA_SDWA_GEOGRAPHIC_AREAS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_SDWA_SDWA_GEOGRAPHIC_AREAS, from the
...
from {{ source('ripple_raw', 'FED_EPA_SDWA_SDWA_GEOGRAPHIC_AREAS') }} as source
