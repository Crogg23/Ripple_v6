{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_OPEN_DATA_BR_6083BC2934') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_OPEN_DATA_BR_6083BC2934, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_OPEN_DATA_BR_6083BC2934') }} as source
