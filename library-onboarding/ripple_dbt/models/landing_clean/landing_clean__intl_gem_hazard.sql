{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_GEM_HAZARD') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_GEM_HAZARD, from the
...
from {{ source('ripple_raw', 'INTL_GEM_HAZARD') }} as source
