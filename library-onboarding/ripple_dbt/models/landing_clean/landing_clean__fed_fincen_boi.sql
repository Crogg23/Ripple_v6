{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FINCEN_BOI') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FINCEN_BOI, from the
...
from {{ source('ripple_raw', 'FED_FINCEN_BOI') }} as source
