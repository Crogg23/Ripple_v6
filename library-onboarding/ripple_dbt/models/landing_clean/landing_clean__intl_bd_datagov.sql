{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_BD_DATAGOV') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_BD_DATAGOV, from the
...
from {{ source('ripple_raw', 'INTL_BD_DATAGOV') }} as source
