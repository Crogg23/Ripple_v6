{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_CONNECTICUT_OPEN_F42EDA9B76') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_CONNECTICUT_OPEN_F42EDA9B76, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_CONNECTICUT_OPEN_F42EDA9B76') }} as source
