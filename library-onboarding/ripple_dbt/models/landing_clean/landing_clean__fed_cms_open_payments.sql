{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_OPEN_PAYMENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_OPEN_PAYMENTS, from the
...
from {{ source('ripple_raw', 'FED_CMS_OPEN_PAYMENTS') }} as source
