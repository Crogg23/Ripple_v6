{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_UK_SANCTIONS_LIST') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_UK_SANCTIONS_LIST, from the
...
from {{ source('ripple_raw', 'XC_UK_SANCTIONS_LIST') }} as source
