{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_COURTLISTENER_SCHOOLS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_COURTLISTENER_SCHOOLS, from the
...
from {{ source('ripple_raw', 'FED_COURTLISTENER_SCHOOLS') }} as source
