{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_134A12A020') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_134A12A020, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_134A12A020') }} as source
