{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_WASHINGTON_STATE_11CD1995B7') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_WASHINGTON_STATE_11CD1995B7, from the
...
select
    source.*,
    {{ landing_parse_date('"OPENEDDATE"', 'iso', 'TEXT') }} as openeddate_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_SOC_WASHINGTON_STATE_11CD1995B7') }} as source
