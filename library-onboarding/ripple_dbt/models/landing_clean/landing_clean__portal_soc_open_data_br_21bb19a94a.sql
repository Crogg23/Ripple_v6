{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_OPEN_DATA_BR_21BB19A94A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_OPEN_DATA_BR_21BB19A94A, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_OPEN_DATA_BR_21BB19A94A') }} as source
