{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_VIRGINIA_OPEN_DA_A1B2888C0A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_VIRGINIA_OPEN_DA_A1B2888C0A, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_VIRGINIA_OPEN_DA_A1B2888C0A') }} as source
