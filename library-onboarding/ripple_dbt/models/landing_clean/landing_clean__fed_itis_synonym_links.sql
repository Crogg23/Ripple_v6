{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ITIS_SYNONYM_LINKS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ITIS_SYNONYM_LINKS, from the
...
from {{ source('ripple_raw', 'FED_ITIS_SYNONYM_LINKS') }} as source
