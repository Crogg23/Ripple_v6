{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA860_4_OWNER') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA860_4_OWNER, from the
...
from {{ source('ripple_raw', 'FED_EIA860_4_OWNER') }} as source
