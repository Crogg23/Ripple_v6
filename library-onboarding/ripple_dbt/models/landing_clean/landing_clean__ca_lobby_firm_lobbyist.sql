{{ config(materialized='view', schema='LANDING_CLEAN', alias='CA_LOBBY_FIRM_LOBBYIST') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.CA_LOBBY_FIRM_LOBBYIST, from the
...
from {{ source('ripple_raw', 'CA_LOBBY_FIRM_LOBBYIST') }} as source
