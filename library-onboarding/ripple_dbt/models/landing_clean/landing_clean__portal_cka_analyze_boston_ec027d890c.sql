{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_EC027D890C') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_EC027D890C, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_EC027D890C') }} as source
