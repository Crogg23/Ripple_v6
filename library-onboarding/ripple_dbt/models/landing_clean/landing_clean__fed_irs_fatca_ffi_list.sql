{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_IRS_FATCA_FFI_LIST') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_IRS_FATCA_FFI_LIST, from the
...
from {{ source('ripple_raw', 'FED_IRS_FATCA_FFI_LIST') }} as source
