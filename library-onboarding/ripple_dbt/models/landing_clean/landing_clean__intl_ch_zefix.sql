{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_CH_ZEFIX') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_CH_ZEFIX, from the
...
from {{ source('ripple_raw', 'INTL_CH_ZEFIX') }} as source
