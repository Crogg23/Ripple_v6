{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_TAMPA_OPEN_DATA_6C25EA91D4') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_TAMPA_OPEN_DATA_6C25EA91D4, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_TAMPA_OPEN_DATA_6C25EA91D4') }} as source
