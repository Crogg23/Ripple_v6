{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_BOP_STATISTICS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_BOP_STATISTICS, from the
...
from {{ source('ripple_raw', 'FED_BOP_STATISTICS') }} as source
