{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_HUD_ASSISTED_HOUSING_PROJECTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_HUD_ASSISTED_HOUSING_PROJECTS, from the
...
from {{ source('ripple_raw', 'FED_HUD_ASSISTED_HOUSING_PROJECTS') }} as source
