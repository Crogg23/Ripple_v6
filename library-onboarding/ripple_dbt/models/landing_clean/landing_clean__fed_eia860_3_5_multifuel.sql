{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA860_3_5_MULTIFUEL') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA860_3_5_MULTIFUEL, from the
...
from {{ source('ripple_raw', 'FED_EIA860_3_5_MULTIFUEL') }} as source
