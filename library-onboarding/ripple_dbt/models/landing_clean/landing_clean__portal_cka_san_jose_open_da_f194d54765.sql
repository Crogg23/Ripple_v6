{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_SAN_JOSE_OPEN_DA_F194D54765') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_SAN_JOSE_OPEN_DA_F194D54765, from the
...
select
    source.*,
    {{ landing_parse_date('"DATEDIMID"', 'ymd8', 'TEXT') }} as datedimid_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_SAN_JOSE_OPEN_DA_F194D54765') }} as source
