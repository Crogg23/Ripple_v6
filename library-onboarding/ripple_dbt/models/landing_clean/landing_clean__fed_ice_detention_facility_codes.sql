{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ICE_DETENTION_FACILITY_CODES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ICE_DETENTION_FACILITY_CODES, from the
...
from {{ source('ripple_raw', 'FED_ICE_DETENTION_FACILITY_CODES') }} as source
