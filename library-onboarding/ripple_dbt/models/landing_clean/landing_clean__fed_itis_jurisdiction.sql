{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ITIS_JURISDICTION') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ITIS_JURISDICTION, from the
...
from {{ source('ripple_raw', 'FED_ITIS_JURISDICTION') }} as source
