{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_GFI_TRADE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_GFI_TRADE, from the
...
from {{ source('ripple_raw', 'INTL_GFI_TRADE') }} as source
