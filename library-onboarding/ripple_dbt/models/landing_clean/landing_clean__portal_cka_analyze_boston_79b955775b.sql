{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_79B955775B') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_79B955775B, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_79B955775B') }} as source
