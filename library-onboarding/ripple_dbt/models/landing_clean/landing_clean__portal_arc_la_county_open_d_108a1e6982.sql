{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_LA_COUNTY_OPEN_D_108A1E6982') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_LA_COUNTY_OPEN_D_108A1E6982, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_LA_COUNTY_OPEN_D_108A1E6982') }} as source
