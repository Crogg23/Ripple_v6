{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_COURTLISTENER_DISCLOSURE_DEBTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_COURTLISTENER_DISCLOSURE_DEBTS, from the
...
from {{ source('ripple_raw', 'FED_COURTLISTENER_DISCLOSURE_DEBTS') }} as source
