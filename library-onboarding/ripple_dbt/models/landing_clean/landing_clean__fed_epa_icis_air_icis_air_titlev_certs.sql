{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_ICIS_AIR_ICIS_AIR_TITLEV_CERTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_ICIS_AIR_ICIS_AIR_TITLEV_CERTS, from the
...
from {{ source('ripple_raw', 'FED_EPA_ICIS_AIR_ICIS_AIR_TITLEV_CERTS') }} as source
