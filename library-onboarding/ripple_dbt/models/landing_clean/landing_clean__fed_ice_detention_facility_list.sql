{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ICE_DETENTION_FACILITY_LIST') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ICE_DETENTION_FACILITY_LIST, from the
...
from {{ source('ripple_raw', 'FED_ICE_DETENTION_FACILITY_LIST') }} as source
