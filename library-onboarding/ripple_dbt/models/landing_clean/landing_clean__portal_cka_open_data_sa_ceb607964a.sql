{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_CEB607964A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_CEB607964A, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_CEB607964A') }} as source
