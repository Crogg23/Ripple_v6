{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_DC31E10278') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_DC31E10278, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_DC31E10278') }} as source
