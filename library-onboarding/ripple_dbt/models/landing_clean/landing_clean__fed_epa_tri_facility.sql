{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_TRI_FACILITY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_TRI_FACILITY, from the
...
from {{ source('ripple_raw', 'FED_EPA_TRI_FACILITY') }} as source
