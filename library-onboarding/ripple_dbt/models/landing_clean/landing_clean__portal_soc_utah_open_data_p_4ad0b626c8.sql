{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_UTAH_OPEN_DATA_P_4AD0B626C8') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_UTAH_OPEN_DATA_P_4AD0B626C8, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_UTAH_OPEN_DATA_P_4AD0B626C8') }} as source
