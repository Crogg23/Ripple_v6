{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_GINI') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_GINI, from the
...
from {{ source('ripple_raw', 'XC_OWID_GINI') }} as source
