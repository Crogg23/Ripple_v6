{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_WPA_SLAVE_NARRATIVES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_WPA_SLAVE_NARRATIVES, from the
...
from {{ source('ripple_raw', 'FED_WPA_SLAVE_NARRATIVES') }} as source
