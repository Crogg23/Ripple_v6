{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_AIR_EMISSIONS_POLL_RPT_COMBINED_EMISSIONS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_AIR_EMISSIONS_POLL_RPT_COMBINED_EMISSIONS, from the
...
from {{ source('ripple_raw', 'FED_EPA_AIR_EMISSIONS_POLL_RPT_COMBINED_EMISSIONS') }} as source
