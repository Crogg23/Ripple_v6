{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_COLORADO_INFORMA_6367A44C92') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_COLORADO_INFORMA_6367A44C92, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_COLORADO_INFORMA_6367A44C92') }} as source
