{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_HRSA_UDS_HEALTH_CENTER_INFO') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_HRSA_UDS_HEALTH_CENTER_INFO, from the
...
from {{ source('ripple_raw', 'FED_HRSA_UDS_HEALTH_CENTER_INFO') }} as source
