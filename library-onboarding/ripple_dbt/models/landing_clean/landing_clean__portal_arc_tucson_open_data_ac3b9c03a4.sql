{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_TUCSON_OPEN_DATA_AC3B9C03A4') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_TUCSON_OPEN_DATA_AC3B9C03A4, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_TUCSON_OPEN_DATA_AC3B9C03A4') }} as source
