{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_MSRB_REGISTRANTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_MSRB_REGISTRANTS, from the
...
from {{ source('ripple_raw', 'FED_MSRB_REGISTRANTS') }} as source
