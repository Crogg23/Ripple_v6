{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_VERMONT_OPEN_GEO_62F10327D4') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_VERMONT_OPEN_GEO_62F10327D4, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_VERMONT_OPEN_GEO_62F10327D4') }} as source
