{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_MEMPHIS_OPEN_DAT_9F6F4B2736') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_MEMPHIS_OPEN_DAT_9F6F4B2736, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_MEMPHIS_OPEN_DAT_9F6F4B2736') }} as source
