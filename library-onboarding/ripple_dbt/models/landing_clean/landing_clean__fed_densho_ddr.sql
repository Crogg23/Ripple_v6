{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_DENSHO_DDR') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_DENSHO_DDR, from the
...
from {{ source('ripple_raw', 'FED_DENSHO_DDR') }} as source
