{{ config(materialized='view', schema='LANDING_CLEAN', alias='ST_NYC_CFB_CAMPAIGN_2025_CONTRIBUTIONS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.ST_NYC_CFB_CAMPAIGN_2025_CONTRIBUTIONS, from the
...
from {{ source('ripple_raw', 'ST_NYC_CFB_CAMPAIGN_2025_CONTRIBUTIONS') }} as source
