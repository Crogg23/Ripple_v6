{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FFIEC_CALL_REPORTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FFIEC_CALL_REPORTS, from the
...
from {{ source('ripple_raw', 'FED_FFIEC_CALL_REPORTS') }} as source
