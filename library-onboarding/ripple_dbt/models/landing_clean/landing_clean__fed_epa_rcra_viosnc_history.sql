{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_RCRA_VIOSNC_HISTORY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_RCRA_VIOSNC_HISTORY, from the
...
from {{ source('ripple_raw', 'FED_EPA_RCRA_VIOSNC_HISTORY') }} as source
