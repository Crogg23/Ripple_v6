{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_EMBL_ENSEMBL') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_EMBL_ENSEMBL, from the
...
from {{ source('ripple_raw', 'INTL_EMBL_ENSEMBL') }} as source
