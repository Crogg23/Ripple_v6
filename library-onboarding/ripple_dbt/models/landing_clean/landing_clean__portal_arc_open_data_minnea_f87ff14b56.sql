{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_MINNEA_F87FF14B56') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_MINNEA_F87FF14B56, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_MINNEA_F87FF14B56') }} as source
