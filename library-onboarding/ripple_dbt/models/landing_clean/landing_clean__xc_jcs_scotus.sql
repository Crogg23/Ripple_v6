{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_JCS_SCOTUS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_JCS_SCOTUS, from the
...
from {{ source('ripple_raw', 'XC_JCS_SCOTUS') }} as source
