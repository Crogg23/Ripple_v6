{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SENATE_STOCK_WATCHER') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SENATE_STOCK_WATCHER, from the
...
from {{ source('ripple_raw', 'FED_SENATE_STOCK_WATCHER') }} as source
