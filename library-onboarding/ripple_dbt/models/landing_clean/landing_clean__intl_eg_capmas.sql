{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_EG_CAPMAS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_EG_CAPMAS, from the
...
from {{ source('ripple_raw', 'INTL_EG_CAPMAS') }} as source
