{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FEC_LEADERSHIP_PAC') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FEC_LEADERSHIP_PAC, from the
...
from {{ source('ripple_raw', 'FED_FEC_LEADERSHIP_PAC') }} as source
