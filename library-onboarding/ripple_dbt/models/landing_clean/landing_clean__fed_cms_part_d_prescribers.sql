{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_PART_D_PRESCRIBERS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_PART_D_PRESCRIBERS, from the
...
from {{ source('ripple_raw', 'FED_CMS_PART_D_PRESCRIBERS') }} as source
