{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_HARRIS_COUNTY_OP_6133483DE0') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_HARRIS_COUNTY_OP_6133483DE0, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_HARRIS_COUNTY_OP_6133483DE0') }} as source
