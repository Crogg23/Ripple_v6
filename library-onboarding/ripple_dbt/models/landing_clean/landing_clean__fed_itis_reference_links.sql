{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ITIS_REFERENCE_LINKS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ITIS_REFERENCE_LINKS, from the
...
from {{ source('ripple_raw', 'FED_ITIS_REFERENCE_LINKS') }} as source
