{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_WISCONSIN_OPEN_D_07CF3C3824') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_WISCONSIN_OPEN_D_07CF3C3824, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_WISCONSIN_OPEN_D_07CF3C3824') }} as source
