{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_DATALA_LOS_ANGEL_A94A3A65BD') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_DATALA_LOS_ANGEL_A94A3A65BD, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_DATALA_LOS_ANGEL_A94A3A65BD') }} as source
