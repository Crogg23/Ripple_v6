{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA860_3_3_SOLAR') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA860_3_3_SOLAR, from the
...
from {{ source('ripple_raw', 'FED_EIA860_3_3_SOLAR') }} as source
