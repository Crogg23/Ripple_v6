{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FRA_SAFETY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FRA_SAFETY, from the
...
from {{ source('ripple_raw', 'FED_FRA_SAFETY') }} as source
