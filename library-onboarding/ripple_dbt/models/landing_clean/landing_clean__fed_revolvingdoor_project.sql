{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_REVOLVINGDOOR_PROJECT') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_REVOLVINGDOOR_PROJECT, from the
...
from {{ source('ripple_raw', 'FED_REVOLVINGDOOR_PROJECT') }} as source
