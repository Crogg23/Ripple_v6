{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_HOSPITAL_COMPARE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_HOSPITAL_COMPARE, from the
...
from {{ source('ripple_raw', 'FED_CMS_HOSPITAL_COMPARE') }} as source
