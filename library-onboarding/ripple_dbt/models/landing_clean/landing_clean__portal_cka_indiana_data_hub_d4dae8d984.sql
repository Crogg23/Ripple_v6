{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_INDIANA_DATA_HUB_D4DAE8D984') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_INDIANA_DATA_HUB_D4DAE8D984, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_INDIANA_DATA_HUB_D4DAE8D984') }} as source
