{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_USITC_DATAWEB') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_USITC_DATAWEB, from the
...
from {{ source('ripple_raw', 'FED_USITC_DATAWEB') }} as source
