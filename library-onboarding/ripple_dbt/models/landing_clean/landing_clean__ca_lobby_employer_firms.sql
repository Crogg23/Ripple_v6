{{ config(materialized='view', schema='LANDING_CLEAN', alias='CA_LOBBY_EMPLOYER_FIRMS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.CA_LOBBY_EMPLOYER_FIRMS, from the
...
from {{ source('ripple_raw', 'CA_LOBBY_EMPLOYER_FIRMS') }} as source
