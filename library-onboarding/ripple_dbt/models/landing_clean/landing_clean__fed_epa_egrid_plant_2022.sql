{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_EGRID_PLANT_2022') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_EGRID_PLANT_2022, from the
...
from {{ source('ripple_raw', 'FED_EPA_EGRID_PLANT_2022') }} as source
