{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA860_1_UTILITY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA860_1_UTILITY, from the
...
from {{ source('ripple_raw', 'FED_EIA860_1_UTILITY') }} as source
