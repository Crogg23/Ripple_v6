{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_HARRIS_COUNTY_OP_3E3BFD2059') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_HARRIS_COUNTY_OP_3E3BFD2059, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_HARRIS_COUNTY_OP_3E3BFD2059') }} as source
