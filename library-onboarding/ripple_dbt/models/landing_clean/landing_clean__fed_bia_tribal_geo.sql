{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_BIA_TRIBAL_GEO') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_BIA_TRIBAL_GEO, from the
...
from {{ source('ripple_raw', 'FED_BIA_TRIBAL_GEO') }} as source
