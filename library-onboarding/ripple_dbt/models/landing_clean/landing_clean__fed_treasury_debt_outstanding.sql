{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_TREASURY_DEBT_OUTSTANDING') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_TREASURY_DEBT_OUTSTANDING, from the
...
from {{ source('ripple_raw', 'FED_TREASURY_DEBT_OUTSTANDING') }} as source
