{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_NJ_OPEN_DATA_CEN_A0D94510CA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_NJ_OPEN_DATA_CEN_A0D94510CA, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_NJ_OPEN_DATA_CEN_A0D94510CA') }} as source
