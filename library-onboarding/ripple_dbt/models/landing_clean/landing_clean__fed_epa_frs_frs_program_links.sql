{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_FRS_FRS_PROGRAM_LINKS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_FRS_FRS_PROGRAM_LINKS, from the
...
from {{ source('ripple_raw', 'FED_EPA_FRS_FRS_PROGRAM_LINKS') }} as source
