{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_COLORADO_INFORMA_9224CC38D4') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_COLORADO_INFORMA_9224CC38D4, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_COLORADO_INFORMA_9224CC38D4') }} as source
