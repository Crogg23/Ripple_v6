{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_11B21C9100') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_11B21C9100, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_11B21C9100') }} as source
