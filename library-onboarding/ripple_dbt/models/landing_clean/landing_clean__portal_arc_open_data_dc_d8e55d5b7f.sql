{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_DC_D8E55D5B7F') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_DC_D8E55D5B7F, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_DC_D8E55D5B7F') }} as source
