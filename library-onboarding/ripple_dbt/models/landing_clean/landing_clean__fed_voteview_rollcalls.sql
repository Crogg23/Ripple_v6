{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_VOTEVIEW_ROLLCALLS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_VOTEVIEW_ROLLCALLS, from the
...
from {{ source('ripple_raw', 'FED_VOTEVIEW_ROLLCALLS') }} as source
