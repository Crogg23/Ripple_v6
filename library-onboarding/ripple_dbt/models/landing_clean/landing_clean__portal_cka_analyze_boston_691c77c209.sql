{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_691C77C209') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_691C77C209, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_691C77C209') }} as source
