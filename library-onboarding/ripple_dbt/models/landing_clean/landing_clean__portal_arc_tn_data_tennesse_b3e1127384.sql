{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_TN_DATA_TENNESSE_B3E1127384') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_TN_DATA_TENNESSE_B3E1127384, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_TN_DATA_TENNESSE_B3E1127384') }} as source
