{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_TN_DATA_TENNESSE_6321C469FE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_TN_DATA_TENNESSE_6321C469FE, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_TN_DATA_TENNESSE_6321C469FE') }} as source
