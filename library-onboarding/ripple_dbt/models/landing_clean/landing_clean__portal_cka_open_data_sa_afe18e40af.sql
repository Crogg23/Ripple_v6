{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_AFE18E40AF') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_AFE18E40AF, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_AFE18E40AF') }} as source
