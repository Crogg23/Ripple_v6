{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_WAPO_FATAL_FORCE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_WAPO_FATAL_FORCE, from the
...
from {{ source('ripple_raw', 'XC_WAPO_FATAL_FORCE') }} as source
