{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_OSHA_ITA_CASE_DETAIL_2023') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_OSHA_ITA_CASE_DETAIL_2023, from the
...
select
    ...
    {{ landing_parse_date('"DATE_OF_DEATH"', 'us', 'TEXT') }} as date_of_death_clean_ts,
    {{ landing_parse_audit_epoch('"INGESTED_AT"') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'FED_OSHA_ITA_CASE_DETAIL_2023') }} as source
