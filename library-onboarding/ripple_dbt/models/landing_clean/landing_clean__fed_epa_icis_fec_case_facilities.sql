{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_ICIS_FEC_CASE_FACILITIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_ICIS_FEC_CASE_FACILITIES, from the
...
from {{ source('ripple_raw', 'FED_EPA_ICIS_FEC_CASE_FACILITIES') }} as source
