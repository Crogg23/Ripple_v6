{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_LEIDEN_RUSSIAN_OPS_EUROPE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_LEIDEN_RUSSIAN_OPS_EUROPE, from the
...
from {{ source('ripple_raw', 'INTL_LEIDEN_RUSSIAN_OPS_EUROPE') }} as source
