{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_MAPPING_INEQUALITY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_MAPPING_INEQUALITY, from the
...
from {{ source('ripple_raw', 'FED_MAPPING_INEQUALITY') }} as source
