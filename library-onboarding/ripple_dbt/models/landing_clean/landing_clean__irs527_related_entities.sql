{{ config(materialized='view', schema='LANDING_CLEAN', alias='IRS527_RELATED_ENTITIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.IRS527_RELATED_ENTITIES, from the
...
from {{ source('ripple_raw', 'IRS527_RELATED_ENTITIES') }} as source
