{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_5544ABA2E2') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_5544ABA2E2, from the
...
select
    source.*,
    {{ landing_parse_date('"SCORE_CALCULATED_TS"', 'iso', 'TEXT') }} as score_calculated_ts_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_5544ABA2E2') }} as source
