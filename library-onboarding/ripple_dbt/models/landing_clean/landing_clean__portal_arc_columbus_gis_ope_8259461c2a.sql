{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_COLUMBUS_GIS_OPE_8259461C2A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_COLUMBUS_GIS_OPE_8259461C2A, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_COLUMBUS_GIS_OPE_8259461C2A') }} as source
