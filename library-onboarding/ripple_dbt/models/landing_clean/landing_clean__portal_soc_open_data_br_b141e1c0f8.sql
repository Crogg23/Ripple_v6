{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_OPEN_DATA_BR_B141E1C0F8') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_OPEN_DATA_BR_B141E1C0F8, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_OPEN_DATA_BR_B141E1C0F8') }} as source
