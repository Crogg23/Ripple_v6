{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_GHGRP_EMISSION') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_GHGRP_EMISSION, from the
...
from {{ source('ripple_raw', 'FED_EPA_GHGRP_EMISSION') }} as source
