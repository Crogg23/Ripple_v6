{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_HPT_MRF') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_HPT_MRF, from the
...
from {{ source('ripple_raw', 'FED_CMS_HPT_MRF') }} as source
