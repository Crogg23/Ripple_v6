{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_PA_OPEN_DATA_POR_CD66682741') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_PA_OPEN_DATA_POR_CD66682741, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_PA_OPEN_DATA_POR_CD66682741') }} as source
