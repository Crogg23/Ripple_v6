{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_TUCSON_OPEN_DATA_65A6CDEF8F') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_TUCSON_OPEN_DATA_65A6CDEF8F, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_TUCSON_OPEN_DATA_65A6CDEF8F') }} as source
