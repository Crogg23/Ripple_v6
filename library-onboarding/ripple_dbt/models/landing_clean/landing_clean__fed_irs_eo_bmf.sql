{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_IRS_EO_BMF') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_IRS_EO_BMF, from the
...
from {{ source('ripple_raw', 'FED_IRS_EO_BMF') }} as source
