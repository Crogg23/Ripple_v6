{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_DC_5CB81ACBDD') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_DC_5CB81ACBDD, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_DC_5CB81ACBDD') }} as source
