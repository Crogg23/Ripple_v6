{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_1020CCD06A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_1020CCD06A, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_1020CCD06A') }} as source
