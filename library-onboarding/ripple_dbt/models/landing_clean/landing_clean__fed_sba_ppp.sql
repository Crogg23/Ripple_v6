{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SBA_PPP') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SBA_PPP, from the
...
from {{ source('ripple_raw', 'FED_SBA_PPP') }} as source
