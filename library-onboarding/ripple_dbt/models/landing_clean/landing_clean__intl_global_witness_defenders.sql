{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_GLOBAL_WITNESS_DEFENDERS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_GLOBAL_WITNESS_DEFENDERS, from the
...
from {{ source('ripple_raw', 'INTL_GLOBAL_WITNESS_DEFENDERS') }} as source
