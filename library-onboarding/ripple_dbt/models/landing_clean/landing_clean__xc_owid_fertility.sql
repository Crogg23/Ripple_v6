{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_FERTILITY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_FERTILITY, from the
...
from {{ source('ripple_raw', 'XC_OWID_FERTILITY') }} as source
