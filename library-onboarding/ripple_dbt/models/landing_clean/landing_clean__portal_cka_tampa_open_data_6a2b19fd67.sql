{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_TAMPA_OPEN_DATA_6A2B19FD67') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_TAMPA_OPEN_DATA_6A2B19FD67, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_TAMPA_OPEN_DATA_6A2B19FD67') }} as source
