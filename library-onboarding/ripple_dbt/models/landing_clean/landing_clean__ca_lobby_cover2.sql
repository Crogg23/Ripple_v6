{{ config(materialized='view', schema='LANDING_CLEAN', alias='CA_LOBBY_COVER2') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.CA_LOBBY_COVER2, from the
...
from {{ source('ripple_raw', 'CA_LOBBY_COVER2') }} as source
