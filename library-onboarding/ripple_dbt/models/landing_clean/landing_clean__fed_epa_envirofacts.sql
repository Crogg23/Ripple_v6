{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_ENVIROFACTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_ENVIROFACTS, from the
...
from {{ source('ripple_raw', 'FED_EPA_ENVIROFACTS') }} as source
