{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_TUCSON_OPEN_DATA_F91596293E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_TUCSON_OPEN_DATA_F91596293E, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_TUCSON_OPEN_DATA_F91596293E') }} as source
