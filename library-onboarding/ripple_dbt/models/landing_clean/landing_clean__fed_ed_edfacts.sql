{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ED_EDFACTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ED_EDFACTS, from the
...
from {{ source('ripple_raw', 'FED_ED_EDFACTS') }} as source
