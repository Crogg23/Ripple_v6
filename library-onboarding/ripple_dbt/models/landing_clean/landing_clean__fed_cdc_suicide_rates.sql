{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CDC_SUICIDE_RATES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CDC_SUICIDE_RATES, from the
...
from {{ source('ripple_raw', 'FED_CDC_SUICIDE_RATES') }} as source
