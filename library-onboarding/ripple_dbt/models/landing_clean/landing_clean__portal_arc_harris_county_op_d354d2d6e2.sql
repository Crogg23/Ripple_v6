{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_HARRIS_COUNTY_OP_D354D2D6E2') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_HARRIS_COUNTY_OP_D354D2D6E2, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_HARRIS_COUNTY_OP_D354D2D6E2') }} as source
