{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ITIS_OTHER_SOURCES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ITIS_OTHER_SOURCES, from the
...
from {{ source('ripple_raw', 'FED_ITIS_OTHER_SOURCES') }} as source
