{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_DD50C64C64') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_DD50C64C64, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_DD50C64C64') }} as source
