{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_899BB82358') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_899BB82358, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_899BB82358') }} as source
