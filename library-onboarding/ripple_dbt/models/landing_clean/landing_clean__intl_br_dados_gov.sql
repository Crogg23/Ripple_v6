{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_BR_DADOS_GOV') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_BR_DADOS_GOV, from the
...
from {{ source('ripple_raw', 'INTL_BR_DADOS_GOV') }} as source
