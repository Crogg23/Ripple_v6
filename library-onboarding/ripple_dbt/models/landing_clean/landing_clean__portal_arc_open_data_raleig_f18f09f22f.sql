{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_RALEIG_F18F09F22F') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_RALEIG_F18F09F22F, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_RALEIG_F18F09F22F') }} as source
