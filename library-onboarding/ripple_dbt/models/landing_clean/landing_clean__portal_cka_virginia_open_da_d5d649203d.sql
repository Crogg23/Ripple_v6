{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_VIRGINIA_OPEN_DA_D5D649203D') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_VIRGINIA_OPEN_DA_D5D649203D, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_VIRGINIA_OPEN_DA_D5D649203D') }} as source
