{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_HUD_FHA_SF_PORTFOLIO_SNAPSHOT') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_HUD_FHA_SF_PORTFOLIO_SNAPSHOT, from the
...
from {{ source('ripple_raw', 'FED_HUD_FHA_SF_PORTFOLIO_SNAPSHOT') }} as source
