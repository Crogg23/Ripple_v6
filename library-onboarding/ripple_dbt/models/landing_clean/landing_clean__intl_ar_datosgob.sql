{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_AR_DATOSGOB') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_AR_DATOSGOB, from the
...
from {{ source('ripple_raw', 'INTL_AR_DATOSGOB') }} as source
