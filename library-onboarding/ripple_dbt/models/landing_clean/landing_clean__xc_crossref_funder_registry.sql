{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_CROSSREF_FUNDER_REGISTRY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_CROSSREF_FUNDER_REGISTRY, from the
...
from {{ source('ripple_raw', 'XC_CROSSREF_FUNDER_REGISTRY') }} as source
