{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OKLAHOMA_OPEN_DA_3C2B4D89D6') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OKLAHOMA_OPEN_DA_3C2B4D89D6, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OKLAHOMA_OPEN_DA_3C2B4D89D6') }} as source
