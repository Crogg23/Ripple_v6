{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_IHS_SCB_FACILITY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_IHS_SCB_FACILITY, from the
...
from {{ source('ripple_raw', 'FED_IHS_SCB_FACILITY') }} as source
