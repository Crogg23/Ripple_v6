{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SEC_INSIDER_NONDERIV_TRANS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SEC_INSIDER_NONDERIV_TRANS, from the
...
from {{ source('ripple_raw', 'FED_SEC_INSIDER_NONDERIV_TRANS') }} as source
