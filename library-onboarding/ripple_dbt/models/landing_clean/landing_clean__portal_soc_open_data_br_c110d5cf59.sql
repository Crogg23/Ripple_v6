{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_OPEN_DATA_BR_C110D5CF59') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_OPEN_DATA_BR_C110D5CF59, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_OPEN_DATA_BR_C110D5CF59') }} as source
