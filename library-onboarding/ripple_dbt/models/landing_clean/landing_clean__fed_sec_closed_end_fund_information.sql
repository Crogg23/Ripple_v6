{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SEC_CLOSED_END_FUND_INFORMATION') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SEC_CLOSED_END_FUND_INFORMATION, from the
...
from {{ source('ripple_raw', 'FED_SEC_CLOSED_END_FUND_INFORMATION') }} as source
