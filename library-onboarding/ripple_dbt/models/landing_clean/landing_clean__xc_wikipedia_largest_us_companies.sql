{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_WIKIPEDIA_LARGEST_US_COMPANIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_WIKIPEDIA_LARGEST_US_COMPANIES, from the
...
from {{ source('ripple_raw', 'XC_WIKIPEDIA_LARGEST_US_COMPANIES') }} as source
