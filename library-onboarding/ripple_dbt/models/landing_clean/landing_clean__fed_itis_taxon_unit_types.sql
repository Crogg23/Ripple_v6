{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ITIS_TAXON_UNIT_TYPES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ITIS_TAXON_UNIT_TYPES, from the
...
from {{ source('ripple_raw', 'FED_ITIS_TAXON_UNIT_TYPES') }} as source
