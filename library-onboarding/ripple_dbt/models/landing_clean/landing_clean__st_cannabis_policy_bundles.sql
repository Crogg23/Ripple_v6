{{ config(materialized='view', schema='LANDING_CLEAN', alias='ST_CANNABIS_POLICY_BUNDLES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.ST_CANNABIS_POLICY_BUNDLES, from the
...
from {{ source('ripple_raw', 'ST_CANNABIS_POLICY_BUNDLES') }} as source
