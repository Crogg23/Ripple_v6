{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_SANTA_CLARA_COUN_487FCD1FAB') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_SANTA_CLARA_COUN_487FCD1FAB, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_SANTA_CLARA_COUN_487FCD1FAB') }} as source
