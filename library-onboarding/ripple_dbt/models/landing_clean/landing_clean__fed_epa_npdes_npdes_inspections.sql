{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_NPDES_NPDES_INSPECTIONS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_NPDES_NPDES_INSPECTIONS, from the
...
from {{ source('ripple_raw', 'FED_EPA_NPDES_NPDES_INSPECTIONS') }} as source
