{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_MARYLAND_OPEN_DA_BAA13FC4EC') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_MARYLAND_OPEN_DA_BAA13FC4EC, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_MARYLAND_OPEN_DA_BAA13FC4EC') }} as source
