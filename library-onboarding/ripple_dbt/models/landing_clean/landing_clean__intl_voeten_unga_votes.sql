{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_VOETEN_UNGA_VOTES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_VOETEN_UNGA_VOTES, from the
...
from {{ source('ripple_raw', 'INTL_VOETEN_UNGA_VOTES') }} as source
