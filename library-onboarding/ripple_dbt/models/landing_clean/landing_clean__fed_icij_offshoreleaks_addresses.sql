{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ICIJ_OFFSHORELEAKS_ADDRESSES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ICIJ_OFFSHORELEAKS_ADDRESSES, from the
...
from {{ source('ripple_raw', 'FED_ICIJ_OFFSHORELEAKS_ADDRESSES') }} as source
