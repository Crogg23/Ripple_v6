{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_PA_OPEN_DATA_POR_7D4F8FCE94') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_PA_OPEN_DATA_POR_7D4F8FCE94, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_PA_OPEN_DATA_POR_7D4F8FCE94') }} as source
