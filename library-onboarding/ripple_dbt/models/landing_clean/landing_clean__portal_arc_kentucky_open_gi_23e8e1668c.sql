{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_KENTUCKY_OPEN_GI_23E8E1668C') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_KENTUCKY_OPEN_GI_23E8E1668C, from the
...
select
    source.*,
    {{ landing_parse_date('"MODDATE"', 'epochms', 'TEXT') }} as moddate_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_ARC_KENTUCKY_OPEN_GI_23E8E1668C') }} as source
