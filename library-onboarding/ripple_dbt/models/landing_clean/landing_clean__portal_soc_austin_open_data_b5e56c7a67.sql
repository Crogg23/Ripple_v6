{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_AUSTIN_OPEN_DATA_B5E56C7A67') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_AUSTIN_OPEN_DATA_B5E56C7A67, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_AUSTIN_OPEN_DATA_B5E56C7A67') }} as source
