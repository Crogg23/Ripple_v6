{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_SALES_ULT_CUST_CS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_SALES_ULT_CUST_CS, from the
...
from {{ source('ripple_raw', 'FED_EIA861_SALES_ULT_CUST_CS') }} as source
