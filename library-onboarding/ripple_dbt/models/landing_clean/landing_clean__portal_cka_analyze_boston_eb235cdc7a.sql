{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_EB235CDC7A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_EB235CDC7A, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_EB235CDC7A') }} as source
