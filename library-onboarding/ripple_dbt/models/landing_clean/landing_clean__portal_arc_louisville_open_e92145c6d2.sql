{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_LOUISVILLE_OPEN_E92145C6D2') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_LOUISVILLE_OPEN_E92145C6D2, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_LOUISVILLE_OPEN_E92145C6D2') }} as source
