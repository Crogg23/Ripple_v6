{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_UTILITY_DATA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_UTILITY_DATA, from the
...
from {{ source('ripple_raw', 'FED_EIA861_UTILITY_DATA') }} as source
