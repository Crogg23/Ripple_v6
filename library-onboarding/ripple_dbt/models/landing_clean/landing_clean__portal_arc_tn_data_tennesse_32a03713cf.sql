{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_TN_DATA_TENNESSE_32A03713CF') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_TN_DATA_TENNESSE_32A03713CF, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_TN_DATA_TENNESSE_32A03713CF') }} as source
