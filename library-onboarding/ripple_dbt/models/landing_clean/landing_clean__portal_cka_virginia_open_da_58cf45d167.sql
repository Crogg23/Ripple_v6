{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_VIRGINIA_OPEN_DA_58CF45D167') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_VIRGINIA_OPEN_DA_58CF45D167, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_VIRGINIA_OPEN_DA_58CF45D167') }} as source
