{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_JPML_PENDING_MDLS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_JPML_PENDING_MDLS, from the
...
from {{ source('ripple_raw', 'FED_JPML_PENDING_MDLS') }} as source
