{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_CONNECTICUT_OPEN_7909C84EE4') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_CONNECTICUT_OPEN_7909C84EE4, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_CONNECTICUT_OPEN_7909C84EE4') }} as source
