{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_ATLANTA_DATAATLA_898CD032B3') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_ATLANTA_DATAATLA_898CD032B3, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_ATLANTA_DATAATLA_898CD032B3') }} as source
