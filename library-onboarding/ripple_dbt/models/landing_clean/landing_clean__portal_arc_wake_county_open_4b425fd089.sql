{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_WAKE_COUNTY_OPEN_4B425FD089') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_WAKE_COUNTY_OPEN_4B425FD089, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_WAKE_COUNTY_OPEN_4B425FD089') }} as source
