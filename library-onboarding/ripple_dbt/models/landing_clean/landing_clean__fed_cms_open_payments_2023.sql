{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_OPEN_PAYMENTS_2023') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_OPEN_PAYMENTS_2023, from the
...
from {{ source('ripple_raw', 'FED_CMS_OPEN_PAYMENTS_2023') }} as source
