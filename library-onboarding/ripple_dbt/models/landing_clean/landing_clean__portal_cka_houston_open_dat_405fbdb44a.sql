{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_HOUSTON_OPEN_DAT_405FBDB44A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_HOUSTON_OPEN_DAT_405FBDB44A, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_HOUSTON_OPEN_DAT_405FBDB44A') }} as source
