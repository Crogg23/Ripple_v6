{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_AUSTIN_OPEN_DATA_0B4C639A1C') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_AUSTIN_OPEN_DATA_0B4C639A1C, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_AUSTIN_OPEN_DATA_0B4C639A1C') }} as source
