{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_HOSPICE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_HOSPICE, from the
...
from {{ source('ripple_raw', 'FED_CMS_HOSPICE') }} as source
