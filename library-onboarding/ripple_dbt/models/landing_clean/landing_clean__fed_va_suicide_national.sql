{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_VA_SUICIDE_NATIONAL') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_VA_SUICIDE_NATIONAL, from the
...
from {{ source('ripple_raw', 'FED_VA_SUICIDE_NATIONAL') }} as source
