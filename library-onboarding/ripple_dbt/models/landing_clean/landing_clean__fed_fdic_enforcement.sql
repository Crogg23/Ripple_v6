{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FDIC_ENFORCEMENT') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FDIC_ENFORCEMENT, from the
...
from {{ source('ripple_raw', 'FED_FDIC_ENFORCEMENT') }} as source
