{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_CLEVELAND_OPEN_D_590209B88B') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_CLEVELAND_OPEN_D_590209B88B, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_CLEVELAND_OPEN_D_590209B88B') }} as source
