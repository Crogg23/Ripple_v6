{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_6B3408D74F') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_6B3408D74F, from the
...
select
    ...
    {{ landing_parse_date('"DATETIME"', 'iso', 'TEXT') }} as datetime_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_6B3408D74F') }} as source
