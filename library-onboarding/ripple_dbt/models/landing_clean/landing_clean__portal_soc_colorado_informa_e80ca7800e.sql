{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_COLORADO_INFORMA_E80CA7800E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_COLORADO_INFORMA_E80CA7800E, from the
...
select
    source.*,
    {{ landing_parse_date('"EXIT_DATE"', 'iso', 'TEXT') }} as exit_date_clean_ts,
    {{ landing_parse_date('"FISCAL_YEAR"', 'iso', 'TEXT') }} as fiscal_year_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_SOC_COLORADO_INFORMA_E80CA7800E') }} as source
