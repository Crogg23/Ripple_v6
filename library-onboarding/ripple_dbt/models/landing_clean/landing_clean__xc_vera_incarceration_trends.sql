{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_VERA_INCARCERATION_TRENDS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_VERA_INCARCERATION_TRENDS, from the
...
from {{ source('ripple_raw', 'XC_VERA_INCARCERATION_TRENDS') }} as source
