{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FRACFOCUS_REGISTRY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FRACFOCUS_REGISTRY, from the
...
from {{ source('ripple_raw', 'FED_FRACFOCUS_REGISTRY') }} as source
