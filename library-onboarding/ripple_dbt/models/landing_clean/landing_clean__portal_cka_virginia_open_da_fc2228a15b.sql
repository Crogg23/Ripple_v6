{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_VIRGINIA_OPEN_DA_FC2228A15B') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_VIRGINIA_OPEN_DA_FC2228A15B, from the
...
select
    source.*,
    {{ landing_parse_date('"DATE_AND_PICKUP_TIME"', 'us', 'TEXT') }} as date_and_pickup_time_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_VIRGINIA_OPEN_DA_FC2228A15B') }} as source
