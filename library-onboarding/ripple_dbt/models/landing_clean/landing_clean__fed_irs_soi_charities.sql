{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_IRS_SOI_CHARITIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_IRS_SOI_CHARITIES, from the
...
from {{ source('ripple_raw', 'FED_IRS_SOI_CHARITIES') }} as source
