{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SEC_EDGAR_COMPANY_TICKERS_EXCHANGE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SEC_EDGAR_COMPANY_TICKERS_EXCHANGE, from the
...
from {{ source('ripple_raw', 'FED_SEC_EDGAR_COMPANY_TICKERS_EXCHANGE') }} as source
