{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_OCC_NATIONAL_BANKS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_OCC_NATIONAL_BANKS, from the
...
from {{ source('ripple_raw', 'FED_OCC_NATIONAL_BANKS') }} as source
