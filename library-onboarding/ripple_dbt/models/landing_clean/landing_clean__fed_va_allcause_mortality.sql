{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_VA_ALLCAUSE_MORTALITY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_VA_ALLCAUSE_MORTALITY, from the
...
from {{ source('ripple_raw', 'FED_VA_ALLCAUSE_MORTALITY') }} as source
