{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_ORANGE_COUNTY_OP_5E4098F260') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_ORANGE_COUNTY_OP_5E4098F260, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_ORANGE_COUNTY_OP_5E4098F260') }} as source
