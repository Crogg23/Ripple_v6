{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_LOUISVILLE_OPEN_4654B3D9BA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_LOUISVILLE_OPEN_4654B3D9BA, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_LOUISVILLE_OPEN_4654B3D9BA') }} as source
