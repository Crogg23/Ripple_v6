{{ config(materialized='view', schema='LANDING_CLEAN', alias='ST_NYC_CFB_CAMPAIGN_2001_CONTRIBUTION') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.ST_NYC_CFB_CAMPAIGN_2001_CONTRIBUTION, from the
...
from {{ source('ripple_raw', 'ST_NYC_CFB_CAMPAIGN_2001_CONTRIBUTION') }} as source
