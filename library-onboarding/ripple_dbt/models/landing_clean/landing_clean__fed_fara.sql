{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FARA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FARA, from the
...
from {{ source('ripple_raw', 'FED_FARA') }} as source
