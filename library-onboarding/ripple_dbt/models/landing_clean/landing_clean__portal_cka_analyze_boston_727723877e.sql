{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_727723877E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_727723877E, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_727723877E') }} as source
