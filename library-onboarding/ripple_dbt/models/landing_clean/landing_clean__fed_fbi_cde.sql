{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FBI_CDE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FBI_CDE, from the
...
from {{ source('ripple_raw', 'FED_FBI_CDE') }} as source
