{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OKLAHOMA_OPEN_DA_085B547D9C') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OKLAHOMA_OPEN_DA_085B547D9C, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OKLAHOMA_OPEN_DA_085B547D9C') }} as source
