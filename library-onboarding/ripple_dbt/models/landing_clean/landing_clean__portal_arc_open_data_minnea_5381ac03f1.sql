{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_MINNEA_5381AC03F1') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_MINNEA_5381AC03F1, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_MINNEA_5381AC03F1') }} as source
