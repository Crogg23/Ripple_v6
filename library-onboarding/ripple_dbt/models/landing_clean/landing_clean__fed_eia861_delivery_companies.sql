{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_DELIVERY_COMPANIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_DELIVERY_COMPANIES, from the
...
from {{ source('ripple_raw', 'FED_EIA861_DELIVERY_COMPANIES') }} as source
