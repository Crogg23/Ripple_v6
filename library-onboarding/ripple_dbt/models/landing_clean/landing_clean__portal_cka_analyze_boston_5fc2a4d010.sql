{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_5FC2A4D010') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_5FC2A4D010, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_5FC2A4D010') }} as source
