{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_HOUSTON_OPEN_DAT_6082321C0C') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_HOUSTON_OPEN_DAT_6082321C0C, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_HOUSTON_OPEN_DAT_6082321C0C') }} as source
