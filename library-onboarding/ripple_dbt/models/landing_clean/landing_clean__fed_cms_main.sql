{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_MAIN') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_MAIN, from the
...
from {{ source('ripple_raw', 'FED_CMS_MAIN') }} as source
