{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CDC_HEALTH_INSURANCE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CDC_HEALTH_INSURANCE, from the
...
from {{ source('ripple_raw', 'FED_CDC_HEALTH_INSURANCE') }} as source
