{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_CONNECTICUT_OPEN_6BE2302812') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_CONNECTICUT_OPEN_6BE2302812, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_CONNECTICUT_OPEN_6BE2302812') }} as source
