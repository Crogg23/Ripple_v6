{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_IRF') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_IRF, from the
...
from {{ source('ripple_raw', 'FED_CMS_IRF') }} as source
