{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_JCS_MEDIANS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_JCS_MEDIANS, from the
...
from {{ source('ripple_raw', 'XC_JCS_MEDIANS') }} as source
