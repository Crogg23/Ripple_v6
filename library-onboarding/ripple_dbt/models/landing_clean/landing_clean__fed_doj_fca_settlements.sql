{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_DOJ_FCA_SETTLEMENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_DOJ_FCA_SETTLEMENTS, from the
...
from {{ source('ripple_raw', 'FED_DOJ_FCA_SETTLEMENTS') }} as source
