{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_F267F0B038') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_F267F0B038, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_F267F0B038') }} as source
