{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OKLAHOMA_OPEN_DA_BB949BD77E') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OKLAHOMA_OPEN_DA_BB949BD77E, from the
...
select
    source.*,
    {{ landing_parse_date('"PUBLIC_POSTING"', 'iso', 'TEXT') }} as public_posting_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_OKLAHOMA_OPEN_DA_BB949BD77E') }} as source
