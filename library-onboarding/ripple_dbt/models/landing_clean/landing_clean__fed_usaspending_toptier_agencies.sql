{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_USASPENDING_TOPTIER_AGENCIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_USASPENDING_TOPTIER_AGENCIES, from the
...
from {{ source('ripple_raw', 'FED_USASPENDING_TOPTIER_AGENCIES') }} as source
