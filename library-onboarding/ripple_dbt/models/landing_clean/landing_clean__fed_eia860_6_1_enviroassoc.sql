{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA860_6_1_ENVIROASSOC') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA860_6_1_ENVIROASSOC, from the
...
from {{ source('ripple_raw', 'FED_EIA860_6_1_ENVIROASSOC') }} as source
