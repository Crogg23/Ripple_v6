{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_9770EB9EBD') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_9770EB9EBD, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_9770EB9EBD') }} as source
