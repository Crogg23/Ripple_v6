{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_NCUA_FEDERALLY_INSURED_CU_LIST') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_NCUA_FEDERALLY_INSURED_CU_LIST, from the
...
from {{ source('ripple_raw', 'FED_NCUA_FEDERALLY_INSURED_CU_LIST') }} as source
