{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_TAMPA_OPEN_DATA_710A91A2FD') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_TAMPA_OPEN_DATA_710A91A2FD, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_TAMPA_OPEN_DATA_710A91A2FD') }} as source
