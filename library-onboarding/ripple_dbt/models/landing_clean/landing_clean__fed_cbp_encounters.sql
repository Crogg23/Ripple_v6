{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CBP_ENCOUNTERS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CBP_ENCOUNTERS, from the
...
from {{ source('ripple_raw', 'FED_CBP_ENCOUNTERS') }} as source
