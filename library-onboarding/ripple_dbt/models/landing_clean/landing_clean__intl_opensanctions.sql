{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_OPENSANCTIONS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_OPENSANCTIONS, from the
...
from {{ source('ripple_raw', 'INTL_OPENSANCTIONS') }} as source
