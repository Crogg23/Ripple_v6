{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CDC_OVERDOSE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CDC_OVERDOSE, from the
...
from {{ source('ripple_raw', 'FED_CDC_OVERDOSE') }} as source
