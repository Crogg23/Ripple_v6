{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA860_3_4_ENERGY_STORAGE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA860_3_4_ENERGY_STORAGE, from the
...
from {{ source('ripple_raw', 'FED_EIA860_3_4_ENERGY_STORAGE') }} as source
