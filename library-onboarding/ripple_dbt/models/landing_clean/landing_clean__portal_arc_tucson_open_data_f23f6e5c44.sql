{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_TUCSON_OPEN_DATA_F23F6E5C44') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_TUCSON_OPEN_DATA_F23F6E5C44, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_TUCSON_OPEN_DATA_F23F6E5C44') }} as source
