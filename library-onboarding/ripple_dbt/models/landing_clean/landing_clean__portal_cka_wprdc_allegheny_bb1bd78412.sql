{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_WPRDC_ALLEGHENY_BB1BD78412') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_WPRDC_ALLEGHENY_BB1BD78412, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_WPRDC_ALLEGHENY_BB1BD78412') }} as source
