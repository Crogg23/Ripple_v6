{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FAA_ADIP_PRIVATE_AIRPORTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FAA_ADIP_PRIVATE_AIRPORTS, from the
...
from {{ source('ripple_raw', 'FED_FAA_ADIP_PRIVATE_AIRPORTS') }} as source
