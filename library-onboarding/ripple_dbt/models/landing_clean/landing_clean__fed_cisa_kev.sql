{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CISA_KEV') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CISA_KEV, from the
...
from {{ source('ripple_raw', 'FED_CISA_KEV') }} as source
