{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_GE_DATAGOV') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_GE_DATAGOV, from the
...
from {{ source('ripple_raw', 'INTL_GE_DATAGOV') }} as source
