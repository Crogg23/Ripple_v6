{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FATCA_FFI') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FATCA_FFI, from the
...
from {{ source('ripple_raw', 'FED_FATCA_FFI') }} as source
