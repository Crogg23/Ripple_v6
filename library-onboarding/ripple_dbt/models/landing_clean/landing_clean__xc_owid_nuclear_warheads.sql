{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_NUCLEAR_WARHEADS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_NUCLEAR_WARHEADS, from the
...
from {{ source('ripple_raw', 'XC_OWID_NUCLEAR_WARHEADS') }} as source
