{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ISRAEL_NATIONAL_B87C2B5695') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ISRAEL_NATIONAL_B87C2B5695, from the
...
select
    source.*,
    {{ landing_parse_date('"LICENSEEXPIRATIONDATE"', 'iso', 'TEXT') }} as licenseexpirationdate_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_ISRAEL_NATIONAL_B87C2B5695') }} as source
