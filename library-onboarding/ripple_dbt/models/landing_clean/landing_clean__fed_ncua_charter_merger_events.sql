{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_NCUA_CHARTER_MERGER_EVENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_NCUA_CHARTER_MERGER_EVENTS, from the
...
from {{ source('ripple_raw', 'FED_NCUA_CHARTER_MERGER_EVENTS') }} as source
