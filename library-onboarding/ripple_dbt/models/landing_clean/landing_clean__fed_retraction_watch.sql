{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_RETRACTION_WATCH') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_RETRACTION_WATCH, from the
...
from {{ source('ripple_raw', 'FED_RETRACTION_WATCH') }} as source
