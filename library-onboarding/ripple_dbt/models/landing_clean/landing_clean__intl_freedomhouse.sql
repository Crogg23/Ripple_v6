{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_FREEDOMHOUSE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_FREEDOMHOUSE, from the
...
from {{ source('ripple_raw', 'INTL_FREEDOMHOUSE') }} as source
