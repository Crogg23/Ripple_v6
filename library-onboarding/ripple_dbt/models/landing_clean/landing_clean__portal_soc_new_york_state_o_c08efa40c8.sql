{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_NEW_YORK_STATE_O_C08EFA40C8') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_NEW_YORK_STATE_O_C08EFA40C8, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_NEW_YORK_STATE_O_C08EFA40C8') }} as source
