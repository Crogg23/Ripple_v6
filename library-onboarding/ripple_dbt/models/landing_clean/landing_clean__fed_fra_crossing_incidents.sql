{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FRA_CROSSING_INCIDENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FRA_CROSSING_INCIDENTS, from the
...
from {{ source('ripple_raw', 'FED_FRA_CROSSING_INCIDENTS') }} as source
