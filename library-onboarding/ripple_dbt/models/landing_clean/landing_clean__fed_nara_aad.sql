{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_NARA_AAD') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_NARA_AAD, from the
...
from {{ source('ripple_raw', 'FED_NARA_AAD') }} as source
