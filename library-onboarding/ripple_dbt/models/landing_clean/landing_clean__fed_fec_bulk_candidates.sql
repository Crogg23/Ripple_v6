{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FEC_BULK_CANDIDATES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FEC_BULK_CANDIDATES, from the
...
from {{ source('ripple_raw', 'FED_FEC_BULK_CANDIDATES') }} as source
