{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_ADB_DATA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_ADB_DATA, from the
...
from {{ source('ripple_raw', 'INTL_ADB_DATA') }} as source
