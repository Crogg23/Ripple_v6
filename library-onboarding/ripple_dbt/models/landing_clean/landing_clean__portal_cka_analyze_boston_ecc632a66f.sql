{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_ECC632A66F') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_ECC632A66F, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_ECC632A66F') }} as source
