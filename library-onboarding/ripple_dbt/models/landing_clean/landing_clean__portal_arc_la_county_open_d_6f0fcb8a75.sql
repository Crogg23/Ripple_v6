{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_LA_COUNTY_OPEN_D_6F0FCB8A75') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_LA_COUNTY_OPEN_D_6F0FCB8A75, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_LA_COUNTY_OPEN_D_6F0FCB8A75') }} as source
