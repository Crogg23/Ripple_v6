{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_0F7B6B1F80') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_0F7B6B1F80, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_0F7B6B1F80') }} as source
