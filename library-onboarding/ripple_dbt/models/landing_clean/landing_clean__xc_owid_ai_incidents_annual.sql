{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_AI_INCIDENTS_ANNUAL') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_AI_INCIDENTS_ANNUAL, from the
...
from {{ source('ripple_raw', 'XC_OWID_AI_INCIDENTS_ANNUAL') }} as source
