{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_DC_ADF4F0E413') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_DC_ADF4F0E413, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_DC_ADF4F0E413') }} as source
