{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_USCIS_DATA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_USCIS_DATA, from the
...
from {{ source('ripple_raw', 'FED_USCIS_DATA') }} as source
