{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_IRELAND_NATIONAL_7B813F1D72') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_IRELAND_NATIONAL_7B813F1D72, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_IRELAND_NATIONAL_7B813F1D72') }} as source
