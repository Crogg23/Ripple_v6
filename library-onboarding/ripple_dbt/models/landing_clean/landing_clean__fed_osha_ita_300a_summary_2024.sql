{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_OSHA_ITA_300A_SUMMARY_2024') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_OSHA_ITA_300A_SUMMARY_2024, from the
...
from {{ source('ripple_raw', 'FED_OSHA_ITA_300A_SUMMARY_2024') }} as source
