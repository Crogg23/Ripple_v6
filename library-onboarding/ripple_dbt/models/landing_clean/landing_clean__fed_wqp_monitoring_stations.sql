{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_WQP_MONITORING_STATIONS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_WQP_MONITORING_STATIONS, from the
...
from {{ source('ripple_raw', 'FED_WQP_MONITORING_STATIONS') }} as source
