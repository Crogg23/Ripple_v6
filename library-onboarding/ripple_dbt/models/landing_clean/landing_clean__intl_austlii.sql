{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_AUSTLII') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_AUSTLII, from the
...
from {{ source('ripple_raw', 'INTL_AUSTLII') }} as source
