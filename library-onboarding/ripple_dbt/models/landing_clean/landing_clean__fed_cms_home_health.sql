{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_HOME_HEALTH') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_HOME_HEALTH, from the
...
from {{ source('ripple_raw', 'FED_CMS_HOME_HEALTH') }} as source
