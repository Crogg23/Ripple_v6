{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_HRSA_NPDB') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_HRSA_NPDB, from the
...
from {{ source('ripple_raw', 'FED_HRSA_NPDB') }} as source
