{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_COLORADO_INFORMA_DE6C8A6901') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_COLORADO_INFORMA_DE6C8A6901, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_COLORADO_INFORMA_DE6C8A6901') }} as source
