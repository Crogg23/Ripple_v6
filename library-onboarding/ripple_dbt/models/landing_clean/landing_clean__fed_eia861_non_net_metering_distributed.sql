{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_NON_NET_METERING_DISTRIBUTED') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_NON_NET_METERING_DISTRIBUTED, from the
...
from {{ source('ripple_raw', 'FED_EIA861_NON_NET_METERING_DISTRIBUTED') }} as source
