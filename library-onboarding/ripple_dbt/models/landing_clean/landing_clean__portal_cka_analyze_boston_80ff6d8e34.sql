{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_80FF6D8E34') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_80FF6D8E34, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_80FF6D8E34') }} as source
