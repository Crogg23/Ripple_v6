{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_FACILITY_AFFILIATION') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_FACILITY_AFFILIATION, from the
...
from {{ source('ripple_raw', 'FED_CMS_FACILITY_AFFILIATION') }} as source
