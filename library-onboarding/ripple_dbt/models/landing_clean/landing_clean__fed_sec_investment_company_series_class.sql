{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_SEC_INVESTMENT_COMPANY_SERIES_CLASS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_SEC_INVESTMENT_COMPANY_SERIES_CLASS, from the
...
from {{ source('ripple_raw', 'FED_SEC_INVESTMENT_COMPANY_SERIES_CLASS') }} as source
