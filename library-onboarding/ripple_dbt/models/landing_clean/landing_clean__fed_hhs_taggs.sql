{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_HHS_TAGGS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_HHS_TAGGS, from the
...
from {{ source('ripple_raw', 'FED_HHS_TAGGS') }} as source
