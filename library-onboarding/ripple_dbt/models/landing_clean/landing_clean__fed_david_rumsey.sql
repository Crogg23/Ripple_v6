{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_DAVID_RUMSEY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_DAVID_RUMSEY, from the
...
from {{ source('ripple_raw', 'FED_DAVID_RUMSEY') }} as source
