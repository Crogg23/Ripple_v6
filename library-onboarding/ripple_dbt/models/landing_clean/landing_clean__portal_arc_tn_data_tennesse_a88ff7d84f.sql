{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_TN_DATA_TENNESSE_A88FF7D84F') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_TN_DATA_TENNESSE_A88FF7D84F, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_TN_DATA_TENNESSE_A88FF7D84F') }} as source
