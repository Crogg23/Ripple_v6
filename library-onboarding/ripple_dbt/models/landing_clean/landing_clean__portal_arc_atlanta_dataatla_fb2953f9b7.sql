{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_ATLANTA_DATAATLA_FB2953F9B7') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_ATLANTA_DATAATLA_FB2953F9B7, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_ATLANTA_DATAATLA_FB2953F9B7') }} as source
