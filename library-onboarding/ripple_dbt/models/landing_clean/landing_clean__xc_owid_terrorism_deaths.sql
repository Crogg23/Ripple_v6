{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_TERRORISM_DEATHS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_TERRORISM_DEATHS, from the
...
from {{ source('ripple_raw', 'XC_OWID_TERRORISM_DEATHS') }} as source
