{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_TUCSON_OPEN_DATA_C1ADDCDDD2') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_TUCSON_OPEN_DATA_C1ADDCDDD2, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_TUCSON_OPEN_DATA_C1ADDCDDD2') }} as source
