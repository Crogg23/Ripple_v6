{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA860_2_PLANT') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA860_2_PLANT, from the
...
from {{ source('ripple_raw', 'FED_EIA860_2_PLANT') }} as source
