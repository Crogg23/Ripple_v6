{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ISRAEL_NATIONAL_B0E3B6B19B') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ISRAEL_NATIONAL_B0E3B6B19B, from the
...
select
    source.*,
    {{ landing_parse_date('"RECOGNITION_VALIDITY"', 'us', 'TEXT') }} as recognition_validity_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_CKA_ISRAEL_NATIONAL_B0E3B6B19B') }} as source
