{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_VIRGINIA_OPEN_DA_651C0C423A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_VIRGINIA_OPEN_DA_651C0C423A, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_VIRGINIA_OPEN_DA_651C0C423A') }} as source
