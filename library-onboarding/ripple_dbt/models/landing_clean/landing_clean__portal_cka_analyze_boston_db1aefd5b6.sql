{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ANALYZE_BOSTON_DB1AEFD5B6') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ANALYZE_BOSTON_DB1AEFD5B6, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ANALYZE_BOSTON_DB1AEFD5B6') }} as source
