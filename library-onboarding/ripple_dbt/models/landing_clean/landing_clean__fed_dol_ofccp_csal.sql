{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_DOL_OFCCP_CSAL') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_DOL_OFCCP_CSAL, from the
...
from {{ source('ripple_raw', 'FED_DOL_OFCCP_CSAL') }} as source
