{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_GR_DATAGOV') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_GR_DATAGOV, from the
...
from {{ source('ripple_raw', 'INTL_GR_DATAGOV') }} as source
