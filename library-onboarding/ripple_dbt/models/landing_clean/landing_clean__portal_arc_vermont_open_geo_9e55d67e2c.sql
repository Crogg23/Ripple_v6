{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_VERMONT_OPEN_GEO_9E55D67E2C') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_VERMONT_OPEN_GEO_9E55D67E2C, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_VERMONT_OPEN_GEO_9E55D67E2C') }} as source
