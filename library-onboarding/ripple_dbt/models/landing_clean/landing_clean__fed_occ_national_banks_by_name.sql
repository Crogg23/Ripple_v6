{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_OCC_NATIONAL_BANKS_BY_NAME') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_OCC_NATIONAL_BANKS_BY_NAME, from the
...
from {{ source('ripple_raw', 'FED_OCC_NATIONAL_BANKS_BY_NAME') }} as source
