{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ISRAEL_NATIONAL_E9C63EFCDA') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ISRAEL_NATIONAL_E9C63EFCDA, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ISRAEL_NATIONAL_E9C63EFCDA') }} as source
