{{ config(materialized='view', schema='LANDING_CLEAN', alias='XC_OWID_REFUGEES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.XC_OWID_REFUGEES, from the
...
from {{ source('ripple_raw', 'XC_OWID_REFUGEES') }} as source
