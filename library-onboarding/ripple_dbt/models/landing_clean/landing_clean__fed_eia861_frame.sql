{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA861_FRAME') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA861_FRAME, from the
...
from {{ source('ripple_raw', 'FED_EIA861_FRAME') }} as source
