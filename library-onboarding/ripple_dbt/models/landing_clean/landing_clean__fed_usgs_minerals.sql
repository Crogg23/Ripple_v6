{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_USGS_MINERALS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_USGS_MINERALS, from the
...
from {{ source('ripple_raw', 'FED_USGS_MINERALS') }} as source
