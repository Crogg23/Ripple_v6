{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_HRSA_UDS_TABLE3A_PATIENTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_HRSA_UDS_TABLE3A_PATIENTS, from the
...
from {{ source('ripple_raw', 'FED_HRSA_UDS_TABLE3A_PATIENTS') }} as source
