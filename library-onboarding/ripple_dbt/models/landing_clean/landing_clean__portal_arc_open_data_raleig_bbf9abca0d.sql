{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_RALEIG_BBF9ABCA0D') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_RALEIG_BBF9ABCA0D, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_RALEIG_BBF9ABCA0D') }} as source
