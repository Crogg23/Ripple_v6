{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_IRS_990') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_IRS_990, from the
...
from {{ source('ripple_raw', 'FED_IRS_990') }} as source
