{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_DC_D74755206A') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_DC_D74755206A, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_DC_D74755206A') }} as source
