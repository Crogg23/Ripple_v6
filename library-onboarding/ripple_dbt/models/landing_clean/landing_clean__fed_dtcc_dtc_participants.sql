{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_DTCC_DTC_PARTICIPANTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_DTCC_DTC_PARTICIPANTS, from the
...
from {{ source('ripple_raw', 'FED_DTCC_DTC_PARTICIPANTS') }} as source
