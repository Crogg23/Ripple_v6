{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_ES_BORME') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_ES_BORME, from the
...
from {{ source('ripple_raw', 'INTL_ES_BORME') }} as source
