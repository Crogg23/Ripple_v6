{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CMS_PECOS_PROVIDER_ENROLLMENT') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CMS_PECOS_PROVIDER_ENROLLMENT, from the
...
from {{ source('ripple_raw', 'FED_CMS_PECOS_PROVIDER_ENROLLMENT') }} as source
