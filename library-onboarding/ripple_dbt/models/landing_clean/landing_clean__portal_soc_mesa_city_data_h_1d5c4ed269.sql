{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_MESA_CITY_DATA_H_1D5C4ED269') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_MESA_CITY_DATA_H_1D5C4ED269, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_MESA_CITY_DATA_H_1D5C4ED269') }} as source
