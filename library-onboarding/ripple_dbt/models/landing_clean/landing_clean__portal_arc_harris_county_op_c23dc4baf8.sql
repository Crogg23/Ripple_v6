{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_HARRIS_COUNTY_OP_C23DC4BAF8') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_HARRIS_COUNTY_OP_C23DC4BAF8, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_HARRIS_COUNTY_OP_C23DC4BAF8') }} as source
