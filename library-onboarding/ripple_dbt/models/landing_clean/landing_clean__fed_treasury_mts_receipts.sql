{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_TREASURY_MTS_RECEIPTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_TREASURY_MTS_RECEIPTS, from the
...
from {{ source('ripple_raw', 'FED_TREASURY_MTS_RECEIPTS') }} as source
