{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_IRELAND_NATIONAL_4049D41C91') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_IRELAND_NATIONAL_4049D41C91, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_IRELAND_NATIONAL_4049D41C91') }} as source
