{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_SAN_JOSE_OPEN_DA_5F864A8799') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_SAN_JOSE_OPEN_DA_5F864A8799, from the
...
select
    source.*,
    {{ landing_parse_date('"DATEENDED"', 'iso', 'TEXT') }} as dateended_clean_ts,
...
from {{ source('ripple_raw', 'PORTAL_CKA_SAN_JOSE_OPEN_DA_5F864A8799') }} as source
