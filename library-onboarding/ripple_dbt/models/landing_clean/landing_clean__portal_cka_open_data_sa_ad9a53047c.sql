{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_AD9A53047C') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_AD9A53047C, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_AD9A53047C') }} as source
