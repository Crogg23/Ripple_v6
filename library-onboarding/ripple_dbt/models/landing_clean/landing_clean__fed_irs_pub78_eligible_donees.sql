{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_IRS_PUB78_ELIGIBLE_DONEES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_IRS_PUB78_ELIGIBLE_DONEES, from the
...
from {{ source('ripple_raw', 'FED_IRS_PUB78_ELIGIBLE_DONEES') }} as source
