{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_COURTLISTENER_DISCLOSURE_GIFTS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_COURTLISTENER_DISCLOSURE_GIFTS, from the
...
from {{ source('ripple_raw', 'FED_COURTLISTENER_DISCLOSURE_GIFTS') }} as source
