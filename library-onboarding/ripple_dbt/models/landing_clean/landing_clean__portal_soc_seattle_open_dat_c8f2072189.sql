{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_SEATTLE_OPEN_DAT_C8F2072189') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_SEATTLE_OPEN_DAT_C8F2072189, from the
...
select
    source.*,
    {{ landing_parse_date('"LICENSE_START_DATE"', 'ymd8', 'TEXT') }} as license_start_date_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_SOC_SEATTLE_OPEN_DAT_C8F2072189') }} as source
