{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_IHS_FACILITIES') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_IHS_FACILITIES, from the
...
from {{ source('ripple_raw', 'FED_IHS_FACILITIES') }} as source
