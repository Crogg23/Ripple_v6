{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FBI_NICS_CHECKS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FBI_NICS_CHECKS, from the
...
from {{ source('ripple_raw', 'FED_FBI_NICS_CHECKS') }} as source
