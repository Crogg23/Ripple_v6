{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EIA_860_UTILITY') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EIA_860_UTILITY, from the
...
from {{ source('ripple_raw', 'FED_EIA_860_UTILITY') }} as source
