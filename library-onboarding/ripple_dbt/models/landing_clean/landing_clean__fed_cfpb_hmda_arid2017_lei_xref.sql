{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_CFPB_HMDA_ARID2017_LEI_XREF') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_CFPB_HMDA_ARID2017_LEI_XREF, from the
...
from {{ source('ripple_raw', 'FED_CFPB_HMDA_ARID2017_LEI_XREF') }} as source
