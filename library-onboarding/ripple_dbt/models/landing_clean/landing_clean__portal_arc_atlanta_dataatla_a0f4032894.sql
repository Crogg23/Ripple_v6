{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_ATLANTA_DATAATLA_A0F4032894') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_ATLANTA_DATAATLA_A0F4032894, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_ATLANTA_DATAATLA_A0F4032894') }} as source
