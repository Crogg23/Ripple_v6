{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ITIS_TAXON_AUTHORS_LKP') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ITIS_TAXON_AUTHORS_LKP, from the
...
from {{ source('ripple_raw', 'FED_ITIS_TAXON_AUTHORS_LKP') }} as source
