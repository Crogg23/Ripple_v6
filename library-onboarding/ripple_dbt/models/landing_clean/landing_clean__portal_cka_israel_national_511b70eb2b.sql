{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_ISRAEL_NATIONAL_511B70EB2B') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_ISRAEL_NATIONAL_511B70EB2B, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_ISRAEL_NATIONAL_511B70EB2B') }} as source
