{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ITIS_GEOGRAPHIC_DIV') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ITIS_GEOGRAPHIC_DIV, from the
...
from {{ source('ripple_raw', 'FED_ITIS_GEOGRAPHIC_DIV') }} as source
