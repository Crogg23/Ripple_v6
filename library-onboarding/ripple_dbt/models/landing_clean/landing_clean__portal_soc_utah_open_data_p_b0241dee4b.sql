{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_SOC_UTAH_OPEN_DATA_P_B0241DEE4B') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_SOC_UTAH_OPEN_DATA_P_B0241DEE4B, from the
...
from {{ source('ripple_raw', 'PORTAL_SOC_UTAH_OPEN_DATA_P_B0241DEE4B') }} as source
