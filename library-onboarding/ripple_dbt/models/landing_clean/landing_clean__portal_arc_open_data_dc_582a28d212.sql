{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_OPEN_DATA_DC_582A28D212') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_OPEN_DATA_DC_582A28D212, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_OPEN_DATA_DC_582A28D212') }} as source
