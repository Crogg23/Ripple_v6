{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_MEDSL_HOUSE_RETURNS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_MEDSL_HOUSE_RETURNS, from the
...
from {{ source('ripple_raw', 'FED_MEDSL_HOUSE_RETURNS') }} as source
