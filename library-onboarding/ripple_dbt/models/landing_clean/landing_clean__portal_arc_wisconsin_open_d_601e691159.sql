{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_WISCONSIN_OPEN_D_601E691159') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_WISCONSIN_OPEN_D_601E691159, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_WISCONSIN_OPEN_D_601E691159') }} as source
