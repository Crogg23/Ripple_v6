{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FRB_Z1_CSV') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FRB_Z1_CSV, from the
...
from {{ source('ripple_raw', 'FED_FRB_Z1_CSV') }} as source
