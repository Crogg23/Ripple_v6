{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_FA2A7705EC') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_FA2A7705EC, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_FA2A7705EC') }} as source
