{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_ORANGE_COUNTY_OP_0DEA033879') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_ORANGE_COUNTY_OP_0DEA033879, from the
...
from {{ source('ripple_raw', 'PORTAL_ARC_ORANGE_COUNTY_OP_0DEA033879') }} as source
