{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_CKA_OPEN_DATA_SA_650A56F29C') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_CKA_OPEN_DATA_SA_650A56F29C, from the
...
from {{ source('ripple_raw', 'PORTAL_CKA_OPEN_DATA_SA_650A56F29C') }} as source
