{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_ED_FSA_DATACENTER') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_ED_FSA_DATACENTER, from the
...
from {{ source('ripple_raw', 'FED_ED_FSA_DATACENTER') }} as source
