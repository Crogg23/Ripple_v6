{{ config(materialized='view', schema='LANDING_CLEAN', alias='PORTAL_ARC_LA_COUNTY_OPEN_D_E549C7C921') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.PORTAL_ARC_LA_COUNTY_OPEN_D_E549C7C921, from the
...
select
    source.*,
    {{ landing_parse_date('"DCN"', 'epochms', 'TEXT') }} as dcn_clean_ts,
    {{ landing_parse_date('"INGESTED_AT"', 'iso', 'TEXT') }} as ingested_at_clean_ts
from {{ source('ripple_raw', 'PORTAL_ARC_LA_COUNTY_OPEN_D_E549C7C921') }} as source
