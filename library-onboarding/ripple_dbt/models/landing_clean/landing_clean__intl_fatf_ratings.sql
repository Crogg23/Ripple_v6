{{ config(materialized='view', schema='LANDING_CLEAN', alias='INTL_FATF_RATINGS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.INTL_FATF_RATINGS, from the
...
from {{ source('ripple_raw', 'INTL_FATF_RATINGS') }} as source
