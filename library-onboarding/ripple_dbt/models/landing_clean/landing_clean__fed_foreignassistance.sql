{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_FOREIGNASSISTANCE') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_FOREIGNASSISTANCE, from the
...
from {{ source('ripple_raw', 'FED_FOREIGNASSISTANCE') }} as source
