{{ config(materialized='view', schema='LANDING_CLEAN', alias='FED_EPA_NPDES_NPDES_SICS') }}
...
--
-- Clean date/time columns for LIBRARY_RAW.LANDING.FED_EPA_NPDES_NPDES_SICS, from the
...
from {{ source('ripple_raw', 'FED_EPA_NPDES_NPDES_SICS') }} as source
