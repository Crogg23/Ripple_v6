...
# Deeper: `ripple chart eject q02_bar.py` inlines the plug's real Plotly code here.
...
SQL = """\
SELECT PARTY, COUNT(*) AS N FROM LIBRARY_MARTS.POLITICS.POLITICS__FEC_CANDIDATE GROUP BY PARTY ORDER BY N DESC LIMIT 10
"""
...
fig = plugs.bar(df, x='PARTY', y='N', as_of=meta["as_of"])
# --- end plug call ---
