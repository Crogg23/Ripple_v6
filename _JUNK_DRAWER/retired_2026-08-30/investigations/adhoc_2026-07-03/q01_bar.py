...
# Deeper: `ripple chart eject q01_bar.py` inlines the plug's real Plotly code here.
...
SQL = """\
SELECT FULL_NAME, PARTY, MONEY_RAISED_NET FROM LIBRARY_MARTS.POLITICS.POLITICS__MEMBER_MONEY_RAISED WHERE CYCLE='2024' ORDER BY 3 DESC LIMIT 25
"""
...
fig = plugs.bar(df, x='FULL_NAME', y='MONEY_RAISED_NET', as_of=meta["as_of"])
# --- end plug call ---
