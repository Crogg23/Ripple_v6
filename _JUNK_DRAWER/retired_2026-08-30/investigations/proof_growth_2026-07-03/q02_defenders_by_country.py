...
#     python q02_defenders_by_country.py
# and refresh the browser tab (the .html next to this file is rewritten in place).
# Deeper: `ripple chart eject q02_defenders_by_country.py` inlines the plug's real Plotly code here.
...
SQL = """\
SELECT COUNTRY, COUNT(*) AS DEFENDERS_KILLED FROM LIBRARY_RAW.LANDING.INTL_GLOBAL_WITNESS_DEFENDERS GROUP BY 1 ORDER BY 2 DESC LIMIT 15
"""
...
fig = plugs.bar(df, x='COUNTRY', y='DEFENDERS_KILLED', as_of=meta["as_of"])
# --- end plug call ---
