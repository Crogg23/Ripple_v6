...
| `CONNECT_EDGES` | 4,512 (post-08-28 rebuild; was 4,910) | A, B, KEY, **TIER**, A_COL, B_COL, MATCHED, A_DISTINCT, B_DISTINCT, MATCH_RATE, CONFIDENCE, SAMPLE(VARIANT), RUN_ID, BUILT_AT — **this is a TABLE-to-TABLE edge list (a schema graph), not an entity-to-entity graph** |
