"""Run one numbered statement for deep3 group g47, log it, save result as CSV.

usage: python run.py S01 path/to/stmt.sql
Appends the statement to ../g47.sql and writes g47/S01.csv.
...
with (HERE.parent / "g47.sql").open("a", encoding="utf-8") as f:
