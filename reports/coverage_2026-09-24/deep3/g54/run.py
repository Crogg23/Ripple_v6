"""g54 runner: one connection per batch file, read-only guard, logs every statement.

Usage: python reports/coverage_2026-09-24/deep3/g54/run.py <batch.sql>
Batch file: statements separated by lines starting with '-- [label]'.
Results land in g54/out_<label>.json; every statement is appended to deep3/g54.sql.
"""
import json
import re
import sys
