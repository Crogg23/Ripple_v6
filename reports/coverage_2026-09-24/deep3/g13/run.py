"""g13 deep3 runner. Read-only. Runs one batch file of labelled SELECT/WITH statements.

Usage (repo root): python reports/coverage_2026-09-24/deep3/g13/run.py <batch.sql>
