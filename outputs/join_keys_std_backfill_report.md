...
WRITE 82 | SKIP_MEASURED 59 | SKIP_NO_MEASURE 60 | NO_TABLE 0 | NO_REGISTRY_ROW 0
...
| fed_bls_qcew | (empty) | FIPS | GEO | AREA_FIPS=FIPS(100.0%/3770d) |
...
| fed_cms_medicare_provider | (empty) | NPI,COUNTRY,FIPS,ZIP,NAME | STEEL | NPI=NPI(100.0%/50369d); RNDRNG_PRVDR_LAST_ORG_NAME=NAME(99.98%/27272d); RNDRNG_PRVDR_FIRST_NAME=NAME(95.29%/9434d); RNDRNG_PRVDR_STATE_FIPS=FIPS(100.0%/59d); RNDRNG_PRVDR_ZIP5=ZIP(100.0%/9580d); RNDRNG_PRVDR_CNTRY=COUNTRY(100.0%/4d) |
| fed_cms_open_payments | (empty) | NPI,COUNTRY,ZIP,NAME | STEEL | COVERED_RECIPIENT_TYPE=NAME(100.0%/3d); COVERED_RECIPIENT_PROFILE_ID=NAME(99.76%/44546d); NPI=NPI(99.7%/44371d); COVERED_RECIPIENT_FIRST_NAME=NAME(99.75%/9182d); COVERED_RECIPIENT_MIDDLE_NAME=NAME(40.15%/3479d); COVERED_RECIPIENT_LAST_NAME=NAME(99.73%/23668d); RECIPIENT_PRIMARY_BUSINESS_STREET_ADDRESS_LINE1=NAME(100.0%/34387d); RECIPIENT_PRIMARY_BUSINESS_STREET_ADDRESS_LINE2=NAME(19.69%/3055d); RECIPIENT_CITY=NAME(100.0%/4182d); RECIPIENT_STATE=NAME(91.08%/51d); RECIPIENT_ZIP_CODE=ZIP(100.0%/8545d); RECIPIENT_COUNTRY=COUNTRY(100.0%/3d) |
| fed_cms_open_payments_2022 | NPI,CCN,RECORD_ID,NDC | NPI,COUNTRY,ZIP,NAME | STEEL | COVERED_RECIPIENT_TYPE=NAME(100.0%/3d); COVERED_RECIPIENT_PROFILE_ID=NAME(99.68%/43894d); NPI=NPI(99.57%/42965d); COVERED_RECIPIENT_FIRST_NAME=NAME(99.67%/9086d); COVERED_RECIPIENT_MIDDLE_NAME=NAME(58.92%/3590d); COVERED_RECIPIENT_LAST_NAME=NAME(99.64%/23772d); RECIPIENT_PRIMARY_BUSINESS_STREET_ADDRESS_LINE1=NAME(100.0%/34005d); RECIPIENT_PRIMARY_BUSINESS_STREET_ADDRESS_LINE2=NAME(22.96%/3244d); RECIPIENT_CITY=NAME(100.0%/4175d); RECIPIENT_STATE=NAME(90.99%/51d); RECIPIENT_ZIP_CODE=ZIP(100.0%/8290d); RECIPIENT_COUNTRY=COUNTRY(100.0%/2d) |
| fed_cms_open_payments_2023 | (empty) | NPI,COUNTRY,ZIP,NAME | STEEL | COVERED_RECIPIENT_TYPE=NAME(100.0%/3d); COVERED_RECIPIENT_PROFILE_ID=NAME(99.77%/43725d); NPI=NPI(99.68%/43895d); COVERED_RECIPIENT_FIRST_NAME=NAME(99.77%/9062d); COVERED_RECIPIENT_MIDDLE_NAME=NAME(38.58%/3185d); COVERED_RECIPIENT_LAST_NAME=NAME(99.73%/24102d); RECIPIENT_PRIMARY_BUSINESS_STREET_ADDRESS_LINE1=NAME(100.0%/35128d); RECIPIENT_PRIMARY_BUSINESS_STREET_ADDRESS_LINE2=NAME(20.61%/3208d); RECIPIENT_CITY=NAME(100.0%/4155d); RECIPIENT_STATE=NAME(91.0%/52d); RECIPIENT_ZIP_CODE=ZIP(99.99%/8479d); RECIPIENT_COUNTRY=COUNTRY(100.0%/4d) |
| fed_cms_part_d_prescribers | (empty) | NPI,COUNTRY,FIPS,ZIP,NAME | STEEL | NPI=NPI(100.0%/50919d); PRSCRBR_LAST_ORG_NAME=NAME(99.96%/27165d); PRSCRBR_FIRST_NAME=NAME(100.0%/10907d); PRSCRBR_STATE_FIPS=FIPS(99.91%/55d); PRSCRBR_ZIP5=ZIP(100.0%/9946d); PRSCRBR_CNTRY=COUNTRY(100.0%/4d) |
...
| fed_dol_oflc | (empty) | NAICS,COUNTRY,ZIP,NAME | STRONG | CHANGE_EMPLOYER=NAME(100.0%/13d); EMPLOYER_NAME=NAME(100.0%/14847d); EMPLOYER_BUSINESS_DBA=NAME(7.85%/2030d); EMPLOYER_ADDRESS1=NAME(100.0%/14025d); EMPLOYER_ADDRESS2=NAME(46.72%/2222d); EMPLOYER_CITY=NAME(100.0%/2135d); EMPLOYER_STATE=NAME(92.4%/51d); EMPLOYER_POSTAL_CODE=NAME(100.0%/4591d); EMPLOYER_COUNTRY=COUNTRY(95.84%/2d); EMPLOYER_PROVINCE=NAME(0.77%/98d); EMPLOYER_PHONE=NAME(95.84%/14609d); EMPLOYER_PHONE_EXT=NAME(4.14%/344d); NAICS_CODE=NAICS(100.0%/1208d); AGENT_REPRESENTING_EMPLOYER=NAME(95.84%/2d); AGENT_ATTORNEY_LAW_FIRM_BUSINESS_NAME=NAME(67.07%/2476d); AGENT_ATTORNEY_POSTAL_CODE=ZIP(55.28%/1069d) |
...
| fed_epa_echo | (empty) | NAICS,SIC,COUNTRY,FIPS,LATLON,ZIP,ADDRESS,NAME | STRONG | FAC_NAME=NAME(100.0%/46323d); FAC_STREET=ADDRESS(87.99%/41864d); FAC_ZIP=ZIP(88.28%/14830d); FAC_FIPS_CODE=FIPS(90.06%/2851d); FAC_INDIAN_CNTRY_FLG=COUNTRY(100.0%/2d); FAC_LAT=LATLON(98.14%/44810d); FAC_DERIVED_STCTY_FIPS=FIPS(80.5%/2723d); FAC_DERIVED_ZIP=ZIP(80.48%/13325d); CAA_NAICS=NAICS(8.3%/676d); CWA_NAICS=NAICS(8.1%/438d); RCRA_NAICS=NAICS(32.69%/2236d); FAC_SIC_CODES=SIC(26.3%/1558d); FAC_NAICS_CODES=NAICS(48.14%/3422d) |
| fed_faa_registry | (empty) | COUNTRY,ZIP,ADDRESS,NAME | GEO | NAME=NAME(98.58%/39706d); STREET=ADDRESS(98.57%/35648d); ZIP_CODE=ZIP(98.49%/14291d); COUNTRY=COUNTRY(98.58%/26d) |
| fed_fara | (empty) | NAME | PROBABILISTIC | REGISTRANT_NAME=NAME(100.0%/30d) |
| fed_fcc_licensing | (empty) | ZIP,ADDRESS,NAME | GEO | ENTITY_NAME=NAME(99.65%/48641d); ADDRESS_LINE1=ADDRESS(92.08%/44371d); ZIP_CODE=ZIP(98.76%/16247d); APPLICANT_TYPE_CODE=NAME(99.74%/4d) |
...
| fed_hrsa_shortage_areas | (empty) | FIPS,LATLON,ZIP,ADDRESS,NAME | GEO | HPSA_NAME=NAME(100.0%/13249d); LONGITUDE=LATLON(13.71%/5119d); LATITUDE=LATLON(13.71%/5003d); BHCMIS_ORGANIZATION_IDENTIFICATION_NUMBER=NAME(3.19%/1131d); COMMON_COUNTY_NAME=NAME(100.0%/3038d); COMMON_POSTAL_CODE=ZIP(13.26%/3632d); COMMON_REGION_NAME=NAME(100.0%/10d); COMMON_STATE_COUNTY_FIPS_CODE=FIPS(100.0%/3097d); COMMON_STATE_FIPS_CODE=FIPS(100.0%/58d); COMMON_STATE_NAME=NAME(100.0%/59d); COUNTY_EQUIVALENT_NAME=NAME(100.0%/1892d); HPSA_ADDRESS=ADDRESS(13.17%/4541d); HPSA_COMPONENT_NAME=NAME(100.0%/28666d); HPSA_POSTAL_CODE=ZIP(13.26%/3632d); PRIMARY_STATE_FIPS_CODE=FIPS(100.0%/58d); PRIMARY_STATE_NAME=NAME(100.0%/59d) |
...
| fed_irs_bmf | (empty) | EIN,ZIP,ADDRESS,NAME | STEEL | EIN=EIN(100.0%/50027d); NAME=NAME(100.0%/43442d); STREET=ADDRESS(100.0%/42795d); ZIP=ZIP(100.0%/17325d); C_ORGANIZATION=NAME(100.0%/7d); SORT_NAME=NAME(21.09%/10188d) |
| fed_irs_revocation | (empty) | EIN,COUNTRY,ZIP,ADDRESS,NAME | STEEL | EIN=EIN(100.0%/50906d); LEGAL_NAME=NAME(100.0%/44301d); DBA_NAME=NAME(20.12%/9679d); ORG_ADDRESS=ADDRESS(99.82%/43877d); ZIP_CODE=ZIP(100.0%/17377d); COUNTRY=COUNTRY(100.0%/33d) |
| fed_irs_soi | (empty) | FIPS,ZIP | GEO | STATE_FIPS=FIPS(100.0%/51d); ZIP_CODE=ZIP(92.12%/26442d) |
...
| fed_ncua_call_reports | (empty) | ZIP,NAME | GEO | CU_NAME=NAME(99.97%/5910d); ZIP_CODE=ZIP(99.97%/4480d); TABLE_NAME=NAME(100.0%/20d) |
| fed_noaa_storm_events | (empty) | FIPS,LATLON,NAME | GEO | STATE_FIPS=FIPS(100.0%/68d); MONTH_NAME=NAME(100.0%/12d); CZ_FIPS=FIPS(100.0%/573d); CZ_NAME=NAME(100.0%/3644d); BEGIN_LAT=LATLON(58.65%/10470d); BEGIN_LON=LATLON(58.65%/12626d); END_LAT=LATLON(58.65%/11219d); END_LON=LATLON(58.65%/13513d) |
...
| fed_pbgc_data | (empty) | NAME | PROBABILISTIC | TABLE_NAME=NAME(100.0%/85d); METRIC_NAME=NAME(79.88%/571d) |
| fed_sba_loans | (empty) | ZIP,ADDRESS,NAME | GEO | CDC_NAME=NAME(10.44%/199d); CDC_STREET=ADDRESS(10.05%/191d); CDC_ZIP=ZIP(9.51%/170d); THIRDPARTYLENDER_NAME=NAME(5.5%/998d) |
| fed_sec_edgar | (empty) | CIK,EIN,SIC | STEEL | CIK=CIK(100.0%/20d); EIN=EIN(95.0%/19d); SIC=SIC(100.0%/13d) |
| fed_sec_edgar_financials | (empty) | CIK,EIN,SIC,NAME | STEEL | CIK=CIK(100.0%/8160d); NAME=NAME(100.0%/8326d); SIC=SIC(97.91%/404d); EIN=EIN(77.57%/5785d) |
...
| fed_usaspending_contracts | DUNS,FIPS,NAICS,UEI | UEI,NAICS,COUNTRY,ZIP,NAME | STEEL | AWARDING_AGENCY_NAME=NAME(100.0%/53d); AWARDING_SUB_AGENCY_NAME=NAME(100.0%/136d); FUNDING_AGENCY_NAME=NAME(100.0%/59d); RECIPIENT_UEI=UEI(100.0%/7483d); RECIPIENT_NAME=NAME(100.0%/7305d); RECIPIENT_DOING_BUSINESS_AS_NAME=NAME(5.68%/656d); RECIPIENT_PARENT_UEI=UEI(99.99%/7018d); RECIPIENT_PARENT_NAME=NAME(99.99%/6954d); RECIPIENT_CITY_NAME=NAME(100.0%/2533d); RECIPIENT_STATE_CODE=NAME(83.41%/49d); RECIPIENT_ZIP_4_CODE=ZIP(98.78%/4248d); RECIPIENT_COUNTRY_NAME=COUNTRY(100.0%/77d); PRIMARY_PLACE_OF_PERFORMANCE_CITY_NAME=NAME(96.94%/2277d); NAICS_CODE=NAICS(100.0%/678d); NAICS_DESCRIPTION=NAICS(100.0%/661d) |
| fed_usgs_earthquakes | (empty) | LATLON | GEO | LATITUDE=LATLON(100.0%/45970d); LONGITUDE=LATLON(100.0%/47799d) |
| fed_usgs_minerals | (empty) | COUNTRY,LATLON,NAME | GEO | COUNTRY=COUNTRY(99.99%/136d); SITE_NAME=NAME(99.99%/36495d); LATITUDE=LATLON(99.99%/46186d); LONGITUDE=LATLON(99.99%/47310d) |
| fed_usgs_water | (empty) | LATLON,NAME | GEO | SITE_NAME=NAME(100.0%/3708d); PARAMETER_NAME=NAME(100.0%/4d); LATITUDE=LATLON(100.0%/3746d); LONGITUDE=LATLON(100.0%/3657d) |
| fed_voteview_members | (empty) | BIOGUIDE,ICPSR | STEEL | ICPSR=ICPSR(100.0%/12531d); BIOGUIDE_ID=BIOGUIDE(99.87%/12569d) |
| fed_voteview_rollcalls | (empty) | ICPSR | STEEL | ICPSR=ICPSR(100.0%/639d) |
...
| intl_ie_cro | (empty) | NAME | PROBABILISTIC | COMPANY_NUM=NAME(100.0%/50033d); COMPANY_NAME=NAME(100.0%/50549d); COMPANY_STATUS_CODE=NAME(100.0%/17d); COMPANY_STATUS=NAME(100.0%/14d); COMPANY_TYPE_CODE=NAME(100.0%/33d); COMPANY_TYPE=NAME(100.0%/31d); COMPANY_REG_DATE=NAME(97.95%/11683d); COMPANY_ADDRESS_1=NAME(100.0%/30251d); COMPANY_ADDRESS_2=NAME(92.95%/12302d); COMPANY_ADDRESS_3=NAME(69.6%/4894d); COMPANY_ADDRESS_4=NAME(96.89%/2811d); COMPANY_STATUS_DATE=NAME(60.87%/4010d); COMPANY_NAME_EFF_DATE=NAME(97.94%/11533d); COMPANY_TYPE_EFF_DATE=NAME(97.94%/10674d) |
...
| intl_opensanctions | (empty) | NAME | PROBABILISTIC | NAME=NAME(76.88%/36447d) |
| intl_ucdp_ged | (empty) | COUNTRY,GEOM,LATLON,NAME | GEO | CONFLICT_NAME=NAME(100.0%/1103d); DYAD_NAME=NAME(100.0%/1280d); LATITUDE=LATLON(100.0%/15176d); LONGITUDE=LATLON(100.0%/15484d); GEOM_WKT=GEOM(100.0%/15514d); COUNTRY=COUNTRY(100.0%/105d) |
...
| xc_vera_incarceration_trends | (empty) | FIPS,NAME | GEO | COUNTY_FIPS=FIPS(100.0%/3067d); COUNTY_NAME=NAME(100.0%/1776d); STATE_FIPS=FIPS(100.0%/45d) |
...
- fed_hhs_taggs (EIN,FIPS,ZIP / STEEL)
