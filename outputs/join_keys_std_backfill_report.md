...
| fed_courtlistener_financial_disclosures | (empty) | CL_PERSON_ID | STEEL | PERSON_ID=CL_PERSON_ID(41.11%/3269d) |
| fed_dol_osha_inspections | EIN,FIPS,ZIP | NAICS,SIC,ZIP,ADDRESS,NAME | STRONG | ESTAB_NAME=NAME(100.0%/44586d); SITE_ADDRESS=ADDRESS(99.82%/48744d); SITE_ZIP=ZIP(99.97%/15249d); SIC_CODE=SIC(83.85%/1043d); NAICS_CODE=NAICS(99.95%/1016d); MAIL_STREET=ADDRESS(62.39%/28208d); MAIL_ZIP=ZIP(99.95%/12427d) |
...
| fed_epa_npdes_npdes_cs_violations | NPDES_ID | NPDES_ID | STEEL | NPDES_ID=NPDES_ID(100.0%/9225d) |
| fed_epa_npdes_npdes_formal_enforcement_actions | ACTIVITY_ID,NPDES_ID | NPDES_ID | STEEL | NPDES_ID=NPDES_ID(100.0%/28950d) |
| fed_epa_npdes_npdes_ps_violations | NPDES_ID | NPDES_ID | STEEL | NPDES_ID=NPDES_ID(100.0%/22521d) |
| fed_epa_npdes_npdes_qncr_history | NPDES_ID | NPDES_ID | STEEL | NPDES_ID=NPDES_ID(100.0%/44337d) |
| fed_epa_npdes_npdes_se_violations | NPDES_ID | NPDES_ID | STEEL | NPDES_ID=NPDES_ID(100.0%/28494d) |
...
| fed_faa_aircraft_registry | (empty) | COUNTRY,ZIP,ADDRESS,NAME | GEO | NAME=NAME(98.64%/38404d); STREET=ADDRESS(98.62%/36938d); ZIP_CODE=ZIP(98.56%/14373d); COUNTRY=COUNTRY(98.64%/15d) |
...
| fed_fra_casualties | (empty) | LATLON,NAME | GEO | RAILROAD_NAME=NAME(100.0%/718d); COUNTY_NAME=NAME(25.78%/1152d); STATE_NAME=NAME(100.0%/50d); LATITUDE=LATLON(19.67%/2744d); LONGITUDE=LATLON(19.67%/2782d); REPORTING_PARENT_RAILROAD_NAME=NAME(100.0%/586d); REPORTING_RAILROAD_HOLDING_COMPANY=NAME(100.0%/44d) |
| fed_fra_crossing_incidents | (empty) | NAME | PROBABILISTIC | RAILROAD_NAME=NAME(100.0%/762d); OTHER_RAILROAD_NAME=NAME(1.71%/55d); MAINTENANCE_RAILROAD_NAME=NAME(92.67%/963d); COUNTY_NAME=NAME(99.89%/1741d); STATE_NAME=NAME(100.0%/51d); CITY_NAME=NAME(83.78%/8669d); HIGHWAY_NAME=NAME(99.05%/29206d); TRACK_NAME=NAME(99.77%/8033d); REPORTING_PARENT_RAILROAD_NAME=NAME(100.0%/614d); REPORTING_RAILROAD_HOLDING_COMPANY=NAME(100.0%/42d) |
| fed_fra_equipment_accidents | (empty) | LATLON,NAME | GEO | REPORTING_RAILROAD_NAME=NAME(100.0%/692d); OTHER_RAILROAD_NAME=NAME(8.39%/386d); MAINTENANCE_RAILROAD_NAME=NAME(99.97%/1412d); STATE_NAME=NAME(100.0%/50d); COUNTY_NAME=NAME(98.37%/1512d); TRACK_NAME=NAME(98.81%/16820d); ADJUNCT_NAME_1=NAME(11.47%/18d); ADJUNCT_NAME_2=NAME(1.36%/16d); LATITUDE=LATLON(31.55%/7276d); LONGITUDE=LATLON(31.55%/7546d); REPORTING_PARENT_RAILROAD_NAME=NAME(100.0%/553d); REPORTING_RAILROAD_HOLDING_COMPANY=NAME(100.0%/43d) |
| fed_ice_detainers | (empty) | ICE_FACILITY,COUNTRY,ADDRESS | STEEL | DEPARTURE_COUNTRY=COUNTRY(30.55%/118d); DETENTION_FACILITY_CODE=ICE_FACILITY(100.0%/3410d); CITIZENSHIP_COUNTRY=COUNTRY(100.0%/180d); BIRTH_COUNTRY=COUNTRY(100.0%/183d); CRIMINAL_STREET_GANG_YES_NO=ADDRESS(31.39%/2d) |
| fed_ice_detention_stints | (empty) | ICE_FACILITY,COUNTRY | STEEL | BIRTH_COUNTRY=COUNTRY(100.0%/170d); CITIZENSHIP_COUNTRY=COUNTRY(100.0%/162d); DEPARTURE_COUNTRY=COUNTRY(70.72%/164d); DETENTION_FACILITY_CODE=ICE_FACILITY(100.0%/479d) |
| fed_irs_eo_bmf | (empty) | EIN,ZIP,ADDRESS,NAME | STEEL | EIN=EIN(100.0%/49913d); NAME=NAME(100.0%/44298d); STREET=ADDRESS(100.0%/42777d); ZIP=ZIP(100.0%/17067d); C_ORGANIZATION=NAME(100.0%/7d); SORT_NAME=NAME(20.98%/10438d) |
...
| fed_usaspending_contracts_full_r2 | (empty) | DUNS,UEI,NAICS,COUNTRY,ZIP,NAME | STEEL | AWARDING_AGENCY_NAME=NAME(100.0%/55d); AWARDING_SUB_AGENCY_NAME=NAME(100.0%/149d); FUNDING_AGENCY_NAME=NAME(93.72%/62d); RECIPIENT_UEI=UEI(100.0%/13882d); RECIPIENT_DUNS=DUNS(62.82%/10836d); RECIPIENT_NAME=NAME(100.0%/13165d); RECIPIENT_DOING_BUSINESS_AS_NAME=NAME(4.4%/934d); RECIPIENT_PARENT_UEI=UEI(99.94%/12790d); RECIPIENT_PARENT_NAME=NAME(99.97%/12356d); RECIPIENT_CITY_NAME=NAME(99.98%/3519d); RECIPIENT_STATE_CODE=NAME(82.89%/51d); RECIPIENT_ZIP_4_CODE=ZIP(98.01%/6288d); RECIPIENT_COUNTRY_NAME=COUNTRY(99.52%/77d); PRIMARY_PLACE_OF_PERFORMANCE_CITY_NAME=NAME(95.41%/3034d); NAICS_CODE=NAICS(97.92%/930d); NAICS_DESCRIPTION=NAICS(97.57%/921d) |
...
| intl_opensanctions_default | (empty) | NAME | PROBABILISTIC | NAME=NAME(93.02%/44590d) |
| intl_uk_sanctions_list | (empty) | ADDRESS,NAME | PROBABILISTIC | NAME_6=NAME(99.81%/9904d); NAME_1=NAME(41.62%/2205d); NAME_2=NAME(21.26%/1494d); NAME_3=NAME(4.46%/313d); NAME_4=NAME(0.89%/74d); NAME_TYPE=NAME(99.89%/3d); NAME_NON_LATIN_SCRIPT=NAME(1.66%/198d); REGIME_NAME=NAME(100.0%/31d); ADDRESS_LINE_1=ADDRESS(56.42%/1611d); ADDRESS_LINE_2=ADDRESS(36.21%/905d); ADDRESS_LINE_3=ADDRESS(22.09%/486d); ADDRESS_LINE_4=ADDRESS(9.13%/235d); ADDRESS_LINE_5=ADDRESS(13.22%/300d); ADDRESS_LINE_6=ADDRESS(66.03%/541d); ADDRESS_POSTAL_CODE=ADDRESS(19.76%/636d) |
