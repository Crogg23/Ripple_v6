...
#     python q03_eoir_tab_split.py
# and refresh the browser tab (the .html next to this file is rewritten in place).
# Deeper: `ripple chart eject q03_eoir_tab_split.py` inlines the plug's real Plotly code here.
...
SQL = """\
SELECT SPLIT_PART(CASE_TYPE, CHAR(9), 3) AS ST, COUNT(*) AS N FROM LIBRARY_RAW.LANDING.FED_EOIR_CASE_DATA GROUP BY 1 ORDER BY 2 DESC LIMIT 10
"""
...
fig = plugs.choropleth_state(df, state='ST', value='N', as_of=meta["as_of"])
# --- end plug call ---
