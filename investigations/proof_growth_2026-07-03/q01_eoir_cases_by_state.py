...
#     python q01_eoir_cases_by_state.py
# and refresh the browser tab (the .html next to this file is rewritten in place).
# Deeper: `ripple chart eject q01_eoir_cases_by_state.py` inlines the plug's real Plotly code here.
...
SQL = """\
SELECT SPLIT_PART(CASE_TYPE, CHAR(9), 3) AS STATE, COUNT(*) AS CASES FROM LIBRARY_RAW.LANDING.FED_EOIR_CASE_DATA GROUP BY 1 ORDER BY 2 DESC LIMIT 15
"""
...
fig = plugs.bar(df, as_of=meta["as_of"])
# --- end plug call ---
