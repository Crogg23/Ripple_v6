...
#     python q01_top_raisers_2024.py
# and refresh the browser tab (the .html next to this file is rewritten in place).
# Deeper: `ripple chart eject q01_top_raisers_2024.py` inlines the plug's real Plotly code here.
...
SQL = """\
SELECT FULL_NAME, PARTY, MONEY_RAISED_NET FROM LIBRARY_MARTS.POLITICS.POLITICS__MEMBER_MONEY_RAISED WHERE CYCLE = '2024' ORDER BY MONEY_RAISED_NET DESC LIMIT 25
"""
...
fig = plugs.bar(df, x='FULL_NAME', y='MONEY_RAISED_NET', color='PARTY', as_of=meta["as_of"])
# --- end plug call ---
