...
2026-09-01 — FED_FEC_COMMITTEES repeats 16,943 ids across cycles with NO cycle column; a raw name join inflates itoth money 2.14x. Join FINANCE__FED_FEC_COMMITTEES_DIM instead, and 11% of real money rows carry IS_AMBIGUOUS=true — their type/party/name is a cross-cycle coin flip, filter or caveat before any spend-by-attribute chart.
